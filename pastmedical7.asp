...
<br>
	...
	<div class="QuestionAnswersBox">
		...
		<input type="checkbox" name="TEMPEPQ30410010" value="1" id="TEMPEPQ30410010" class="atLeastOneCheckboxRequired" <%=strTEMPEPQ30410010answer1%>>
		<label for="EPQ30410010">Atypical ductal hyperplasia (ADH)</label><br>
		...
		<input type="checkbox" name="TEMP2EPQ30410010" value="1" id="TEMP2EPQ30410010" class="atLeastOneCheckboxRequired" <%=strTEMP2EPQ30410010answer1%>>
		<label for="EPQ30410010">Lobular carcinoma in situ (LCIS)</label><br>
		...
		<input type="checkbox" name="TEMPEPQ30410020" value="1" id="TEMPEPQ30410020" class="atLeastOneCheckboxRequired" <%=strTEMPEPQ30410020answer1%>>
		<label for="EPQ30410020">Mastitis, abscess, or blocked duct not during breast feeding</label><br>
		<input type="checkbox" name="TEMP2EPQ30410020" value="1" id="TEMP2EPQ30410020" class="atLeastOneCheckboxRequired" <%=strEPQTEMP230410020answer1%>>
		<label for="EPQ30410020">Phyllodes tumor</label><br>

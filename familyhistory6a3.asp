...
Please complete the table below for the genetic condition(s) for which a BLOOD RELATIVE was tested.
    ...
    <form action="familyhistory6a3.asp" method="post" id="formQuestion" name="formQuestion">
...
<% if Session("GI10971000Page1")= "1" then %>
		...
		<tr>
				<td><input id="GI10971000_TXT" type="text" size="25" name="GI10971000_TXT" value='<%=Session("GI10971000_TXT")%>'</td>

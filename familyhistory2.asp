...
if Request.Form("ispostback")="1" then
 ...
 if Session("EPQ30901010Page1")= "1" then 
 ...
 if Session("EPQ30901020Page1")= "1" then 
 ...
 if Session("EPQ30901030Page1")= "1" then 
 ...
 if Session("EPQ30901040Page1")= "1" then 
 ...
 if Session("EPQ30901050Page1")= "1" then
 ...
 if Session("EPQ30901060Page1")= "1" then
 ...
 if Session("EPQ30901080Page1")= "1" then
 ...
 if Session("EPQ30901070Page1")= "1" then
 ...
 if Session("EPQ30901090Page1")= "1" then
 ...
 if Session("EPQ30901100Page1")= "1" then
 ...
 if Session("EPQ30901110Page1")= "1" then
 ...
 if Session("EPQ30901130Page1")= "1" then
...
if Session("EPQ30901140Page1")= "1" then
 ...
 if Session("EPQ30901150Page1")= "1" then
 ...
 if Session("EPQ30901160Page1")= "1" then
 ...
 if Session("EPQ30901170Page1")= "1" then
...
if Request.Form("ContinueID")="1" then
	...
	if Session("FHDisplayCounter") > 6 then
	Session("Page")="3"
	else
...
%>
		...
		<td style="text-align: center;">
		<input type="radio" id="EPQ30918050" type="text" value="2" size="3" name="EPQ30918050" <%=strEPQ30918050answer2%> >
		</td>
		<td style="text-align: center;">

...
if Request.Form("ispostback") <> "1" then
	...
	if Session("HM10402000")="1" then
		strHM10402000answer1="checked"
	end if
	if Session("HM10403000")="1" then
		strHM10403000answer1="checked"
	end if
	if Session("HM10404000")="1" then
		strHM10404000answer1="checked"
	end if
	if Session("HM10405000")="1" then
		strHM10405000answer1="checked"
	end if
	if Session("HM10406000")="1" then
		strHM10406000answer1="checked"
	end if

	if Session("HM10416000")="1" then
		strHM10416000answer1="checked"
	end if
	if Session("HM10407000")="1" then
		strHM10407000answer1="checked"
	end if
...
if Request.Form("ispostback")="1" then
	...
	Session("HM10402000string")= ""
	Session("HM10403000string")= ""
	Session("HM10404000string")= ""
	Session("HM10405000string")= ""
	Session("HM10406000string")= ""
	Session("HM10416000string")= ""
	Session("HM10407000string")= ""
	...
	Session("HM10402000") = Request.Form("HM10402000")
	Session("HM10403000") = Request.Form("HM10403000")
	Session("HM10404000") = Request.Form("HM10404000")
	Session("HM10405000") = Request.Form("HM10405000")
	Session("HM10406000") = Request.Form("HM10406000")
	Session("HM10407000") = Request.Form("HM10407000")
	Session("HM10416000") = Request.Form("HM10416000")
	Session("HM10417000") = Request.Form("HM10417000")
...
<!-- [Question boxes ] -->		
    ...
    <legend class="QuestionBox">
      Have you had any brain or nervous system problems in the past 3 months? Check all that apply.<br>
	  </legend>
...
<span class="column1">
		...
		<label for="EPQ30515020">Dizziness or faintness</label><br>
		<input type="checkbox" class="qTrigger2" name="EPQ30515050" value="1" id="EPQ30515050" <%=strEPQ30515050answer1%>>
...
<span class="column2">
		...
		<label for="EPQ30515040">Numbness or tingling of hands or feet</label><br>
		<input type="checkbox" name="EPQ30515080" value="1" id="EPQ30515080" <%=strEPQ30515080answer1%>>
		<label for="EPQ30515080">Tremors, seizures or convulsions</label><br>
...
<div class="hiddenQ2 eitherNoneOrChecked">
  <fieldset>
	<legend class="QuestionBox">
	...
	<div class="QuestionAnswersBox">
		...
		<input type="checkbox" name="HM10402000" value="1" id="HM10402000" <%=strHM10402000answer1%>>
		<label for="HM10402000">Difficulty concentrating</label><br>
		<input type="checkbox" name="HM10403000" value="1" id="HM10403000" <%=strHM10403000answer1%>>
		<label for="HM10403000">Difficulty remembering</label><br>

		<input type="checkbox" name="HM10404000" value="1" id="HM10404000" <%=strHM10404000answer1%>>
		<label for="HM10404000">Difficulty finding words</label><br>

		<input type="checkbox" name="HM10405000" value="1" id="HM10405000" <%=strHM10405000answer1%>>
		<label for="HM10405000">Difficulty in recognizing people</label><br>
		<input type="checkbox" name="HM10406000" value="1" id="HM10406000" <%=strHM10406000answer1%>>
		<label for="HM10406000">Difficulty with sense of direction</label><br>
		<input type="checkbox" name="HM10416000" value="1" id="HM10416000" <%=strHM10416000answer1%>>
		<label for="HM10416000">Other, specify</label>
	<input id="HM10417000" type="text" maxlength="75" size="15" name="HM10417000" class="requiredIfPreviousCheckbox" value='<%=Session("HM10417000")%>'><br>


<br><br>
		<input type="radio" name="HM10407000" value="1" id="HM10407000" <%=strHM10407000answer1%>>
		<label for="HM10407000">None</label><br>
<br>
	</div></fieldset>		
</div>
<%

...
Have you ever been sunburned severely enough to cause blistering?<br>
	...
	<div class="QuestionAnswersBox">
		<input type="radio" name="EPQ31142000" value="1" class="qTrigger" id="EPQ31142000" <%=strEPQ31142000answer1%>>
		<label for="EPQ31142000">Yes</label><br>
		<input type="radio" name="EPQ31142000" value="0" class="qTriggerOff" id="EPQ31142000" <%=strEPQ31142000answer2%>>
		<label for="EPQ3114200">No</label><br>
		<input type="radio" name="EPQ31142000" value="77" class="qTriggerOff" id="EPQ31142000" <%=strEPQ31142000answer3%>>
		<label for="EPQ3114200">I need help answering question</label><br>
	</div><!-- [ /#AnswerBox] -->
...
<div class="hiddenQ">
	...
	<div class="QuestionAnswersBox">
		...
		<input type="checkbox" name="EPQ31143040" value="1" class="qTriggerOff2" id="EPQ31143040" <%=strEPQ31143040answer1%>>
		<label for="EPQ31143040">16-20 years of age</label><br>
		<input type="checkbox" name="EPQ31143050" value="1" class="qTriggerOff2" id="EPQ31143050" <%=strEPQ31143050answer1%>>

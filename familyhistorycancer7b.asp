...
<div id="formWrapper">
<div id="formBlock">
    <form action="familyhistorycancer7b.asp" method="post" id="formQuestion" name="formQuestion">
...
<%if session("TEMPEPQ30820010FPage2")=1 then%>
...
<%if session("EPQ30808010Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Breast cancer</td>
...
<%if session("EPQ30808020Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30808040Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30808050Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Leukemia</td>
...
<%if session("EPQ30808060Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Lung cancer</td>
...
<%if session("EPQ30808070Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Melanoma</td>
...
<%if session("HM10802000Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("CUTA10803000Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Non-melanoma skin cancer (includes basal, squamous, but not melanoma)</td>				<td style="text-aign: center;"><input type="checkbox" name="CUTA10804010" value="1" id="CUTA10804010" <%=strCUTA10804010answer1%>></td>
				<td style="text-align: center;"><input type="checkbox" name="CUTA10804020" value="1" id="CUTA10804020" <%=strCUTA10804020answer1%>></td>
				k<td style="text-align: center;"><input type="checkbox" name="CUTA10804030" value="1" id="CUTA10804030" <%=strCUTA10804030answer1%>></td>
...
<%if session("EPQ30808120Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30808080Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30808090Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("TEMP1EPQ30820090FPage2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Sarcoma</td>
...
<%if session("TEMP2EPQ30820090FPage2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30808100Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30808030Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30808110Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("TEMP1EPQ30808110Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("TEMP2EPQ30808110Page2")=1 then%>
		    <tr class="eitherOneOrTwoOrMoreCheckboxes">

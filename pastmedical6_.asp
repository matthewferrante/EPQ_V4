...
Please list medical problems, diseases, or conditions that you may have been diagnosed with other than cancer.
  ...
  <fieldset>
    <legend class="QuestionBox">
      Which of the following <u>urinary problems</u> did the doctor say you had? Check all that apply.<br>
	  </legend>
	<div class="QuestionAnswersBox">
<span class="column1">
		<input type="checkbox" name="EPQ30409010" value="1" id="EPQ30409010" class="atLeastOneCheckboxRequired" <%=strEPQ30409010answer1%>>
		<label for="EPQ30409010">Bladder or kidney stones</label><br>
		...
		<input type="checkbox" name="EPQ30409030" value="1" id="EPQ30409030" class="atLeastOneCheckboxRequired" <%=strEPQ30409030answer1%>>
		<label for="EPQ30409030">Kidney failure requiring dialysis or transplant</label><br>
...
<span class="column2">
		<input type="checkbox" name="EPQ30409020" value="1" id="EPQ30409020" class="atLeastOneCheckboxRequired" <%=strEPQ30409020answer1%>>
		<label for="EPQ30409020">Poor kidney function with blood tests<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; showing high creatinine levels</label><br>

...
<div id="formBlock">
	<div id="SpecialNote">
You have now finished Module 5, Current Symptoms.  Please press “Save & Continue” when ready.<br>
	</div>

    <form action="currentsymptoms0.asp" method="post" id="formQuestion" name="formQuestion">

...
if Request.Form("ispostback") <> "1" then
	...
	if Session("EPQ30801000")="1" then
		strEPQ30801000answer1="checked"
	end if
	if Session("EPQ30801000")="0" then
		strEPQ30801000answer2="checked"
	end if
	if Session("EPQ30801000")="99" then
		strEPQ30801000answer3="checked"
	end if
	if Session("EPQ30801000")="77" then
		strEPQ30801000answer4="checked"
	end if
	...
	if Session("EPQ30803000a")="1" then
		strEPQ30803000answer1="checked"
	end if
	if Session("EPQ30803000b")="1" then
		strEPQ30803000answer2="checked"
	end if
	if Session("EPQ30803000c")="1" then
		strEPQ30803000answer3="checked"
	end if
	if Session("EPQ30803000d")="88" then
		strEPQ30803000answer4="checked"
	end if
...
if Request.Form("ispostback")="1" then
	...
	Session("EPQ30801000")= Request.Form("EPQ30801000")
	...
	Session("EPQ30803000a")= Request.Form("EPQ30803000a")
	Session("EPQ30803000b")= Request.Form("EPQ30803000b")
	Session("EPQ30803000c")= Request.Form("EPQ30803000c")
	Session("EPQ30803000d")= Request.Form("EPQ30803000d")
...
Is your mother or father of Ashkenazi Jewish background? (An Ashkenazi Jew is one whose ancestry can be traced to the Jews of Central and Eastern Europe.  Families of this background may have increased risk of some cancers.) Check all that apply.
	</legend>

...
<!-- [Question boxes ] -->
<div id='SpecialNote'>
When you choose a category, additional questions will follow that will allow you to specify what types of surgeries you had.</div>
<br>
<fieldset class="eitherNoneOrChecked">
	<legend class='QuestionBox'>
Which types of surgeries or procedures have you had?  Check all that apply.
	</legend>
...
<% end if %>
		...
		<label for="TEMPEPQ30714020">Head, neck, eye, ear, nose, mouth or thyroid</label><br>

...
if Request.Form("ispostback")="1" then
	Session("THRC30123000") = Request.Form("THRC30123000")
	Session("THRC30124000") = Request.Form("THRC30124000")
end if
...
<br><br>
  <fieldset>
    <legend class="QuestionBox">
      What age or year were you first diagnosed with chronic bronchitis?<br>
	  </legend>
	<div class="QuestionAnswersBox">
		<label for="THRC30121000">at age: </label>
		<input type="text" size="3" maxlength="3" id="THRC30123000" name="THRC30123000" class="yearsExposed requiredIfNotYears" value=<%=Session("THRC30123000")%> > years old

<br><br>
<b> or</b>
<br><br>
		<label for="THRC30122000">in year: </label>
		<input type="text" size="4" maxlength="4" id="THRC30124000" name="THRC30124000" class="yearRange requiredIfNotAge" value=<%=Session("THRC30124000")%> ><br>
	</div><!-- [ /#AnswerBox] -->
  </fieldset>

...
if Request.Form("ispostback") <> "1" then
	...
	if Session("TEMP3EPQ30515020" then
...
Have you ever received any of the following vaccines or medications to prevent an infection? Check all that apply.<br>
	...
	<div class="QuestionAnswersBox">
		...
		<input type="checkbox" name="TEMP2EPQ30515090" value="1" id="TEMP1EPQ30515090" <%=strTEMP2EPQ30515090answer1%>>
		<label for="EPQ30515090">Hepatitis B vaccine</label>	<br>
		<input type="checkbox" name="TEMP3EPQ30515020" value="1" id="TEMP1EPQ30515020" <%=strTEMP3EPQ30515020answer1%>>

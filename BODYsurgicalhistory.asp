...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30754300")=1  %>
<tr>
<td>Esophageal dilation (stretching to open the esophagus)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30754300" type="text" size= "3" name= "TEMPEPQ30754300" value =<%=Session ("TEMPEPQ30754300")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30754300" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30754300" value =<%=Session ("TEMPEPQ30754300")%>>/
<input id="TEMPEPQ30754300" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30754300" value =<%=Session ("TEMPEPQ30754300")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30754550")=1  %>
<tr>
<td>Hernia repair (including abdominal, belly button, groin) with mesh</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30754550" type="text" size= "3" name= "TEMP1EPQ30754550" value =<%=Session ("TEMP1EPQ30754550")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30754550" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30754550" value =<%=Session ("TEMP1EPQ30754550")%>>/
<input id="TEMP1EPQ30754550" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30754550" value =<%=Session ("TEMP1EPQ30754550")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30754550")=1  %>
<tr>
<td>Hernia repair (including abdominal, belly button, groin) without mesh</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30754550" type="text" size= "3" name= "TEMP2EPQ30754550" value =<%=Session ("TEMP2EPQ30754550")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30754550" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30754550" value =<%=Session ("TEMP2EPQ30754550")%>>/
<input id="TEMP2EPQ30754550" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30754550" value =<%=Session ("TEMP2EPQ30754550")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30754600")=1  %>
<tr>
<td>Liver transplant</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30754600" type="text" size= "3" name= "TEMPEPQ30754600" value =<%=Session ("TEMPEPQ30754600")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30754600" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30754600" value =<%=Session ("TEMPEPQ30754600")%>>/
<input id="TEMPEPQ30754600" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30754600" value =<%=Session ("TEMPEPQ30754600")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30754700")=1  %>
<tr>
<td>Reflux surgery (fundoplication)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30754700" type="text" size= "3" name= "TEMPEPQ30754700" value =<%=Session ("TEMPEPQ30754700")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30754700" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30754700" value =<%=Session ("TEMPEPQ30754700")%>>/
<input id="TEMPEPQ30754700" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30754700" value =<%=Session ("TEMPEPQ30754700")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30754900")=1  %>
<tr>
<td>Upper endoscopy or EGD (a test to see inside <br>the esophagus, stomach or duodenum)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30754900" type="text" size= "3" name= "TEMPEPQ30754900" value =<%=Session ("TEMPEPQ30754900")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30754900" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30754900" value =<%=Session ("TEMPEPQ30754900")%>>/
<input id="TEMPEPQ30754900" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30754900" value =<%=Session ("TEMPEPQ30754900")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30755800")=1  %>
<tr>
<td>Benign brain tumor surgery (meningioma surgery)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30755800" type="text" size= "3" name= "TEMP1EPQ30755800" value =<%=Session ("TEMP1EPQ30755800")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30755800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30755800" value =<%=Session ("TEMP1EPQ30755800")%>>/
<input id="TEMP1EPQ30755800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30755800" value =<%=Session ("TEMP1EPQ30755800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP3EPQ30755800")=1  %>
<tr>
<td>Brain tumor surgery (removal or reduction of brain tumor)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP3EPQ30755800" type="text" size= "3" name= "TEMP3EPQ30755800" value =<%=Session ("TEMP3EPQ30755800")%>></td>
<td style="text-align: center;"><input id="TEMP3EPQ30755800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP3EPQ30755800" value =<%=Session ("TEMP3EPQ30755800")%>>/
<input id="TEMP3EPQ30755800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP3EPQ30755800" value =<%=Session ("TEMP3EPQ30755800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP4EPQ30755800")=1  %>
<tr>
<td>Brain aneurysm surgery (neurological clipping or endovascular coiling through your groin)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP4EPQ30755800" type="text" size= "3" name= "TEMP4EPQ30755800" value =<%=Session ("TEMP4EPQ30755800")%>></td>
<td style="text-align: center;"><input id="TEMP4EPQ30755800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP4EPQ30755800" value =<%=Session ("TEMP4EPQ30755800")%>>/
<input id="TEMP4EPQ30755800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP4EPQ30755800" value =<%=Session ("TEMP4EPQ30755800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP5EPQ30755800")=1  %>
<tr>
<td>Cerebral shunt (shunting of fluid in the brain to treat hydrocephalus)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP5EPQ30755800" type="text" size= "3" name= "TEMP5EPQ30755800" value =<%=Session ("TEMP5EPQ30755800")%>></td>
<td style="text-align: center;"><input id="TEMP5EPQ30755800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP5EPQ30755800" value =<%=Session ("TEMP5EPQ30755800")%>>/
<input id="TEMP5EPQ30755800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP5EPQ30755800" value =<%=Session ("TEMP5EPQ30755800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP6EPQ30755800")=1  %>
<tr>
<td>Pituitary gland surgery (transsphenoidal surgery)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP6EPQ30755800" type="text" size= "3" name= "TEMP6EPQ30755800" value =<%=Session ("TEMP6EPQ30755800")%>></td>
<td style="text-align: center;"><input id="TEMP6EPQ30755800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP6EPQ30755800" value =<%=Session ("TEMP6EPQ30755800")%>>/
<input id="TEMP6EPQ30755800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP6EPQ30755800" value =<%=Session ("TEMP6EPQ30755800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP7EPQ30755800")=1  %>
<tr>
<td>Removal of blood (hematoma)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP7EPQ30755800" type="text" size= "3" name= "TEMP7EPQ30755800" value =<%=Session ("TEMP7EPQ30755800")%>></td>
<td style="text-align: center;"><input id="TEMP7EPQ30755800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP7EPQ30755800" value =<%=Session ("TEMP7EPQ30755800")%>>/
<input id="TEMP7EPQ30755800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP7EPQ30755800" value =<%=Session ("TEMP7EPQ30755800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30756950")=1  %>
<tr>
<td>Ablation</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30756950" type="text" size= "3" name= "TEMP1EPQ30756950" value =<%=Session ("TEMP1EPQ30756950")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30756950" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30756950" value =<%=Session ("TEMP1EPQ30756950")%>>/
<input id="TEMP1EPQ30756950" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30756950" value =<%=Session ("TEMP1EPQ30756950")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30757250")=1  %>
<tr>
<td>Pelvic lymph node removal</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30757250" type="text" size= "3" name= "TEMP2EPQ30757250" value =<%=Session ("TEMP2EPQ30757250")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30757250" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30757250" value =<%=Session ("TEMP2EPQ30757250")%>>/
<input id="TEMP2EPQ30757250" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30757250" value =<%=Session ("TEMP2EPQ30757250")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP3EPQ30757250")=1  %>
<tr>
<td>Prolapse surgery or urinary leakage surgery (including sling or suspension)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP3EPQ30757250" type="text" size= "3" name= "TEMP3EPQ30757250" value =<%=Session ("TEMP3EPQ30757250")%>></td>
<td style="text-align: center;"><input id="TEMP3EPQ30757250" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP3EPQ30757250" value =<%=Session ("TEMP3EPQ30757250")%>>/
<input id="TEMP3EPQ30757250" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP3EPQ30757250" value =<%=Session ("TEMP3EPQ30757250")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30757450")=1  %>
<tr>
<td>Cleft lip or palate surgery </td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30757450" type="text" size= "3" name= "TEMP1EPQ30757450" value =<%=Session ("TEMP1EPQ30757450")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30757450" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30757450" value =<%=Session ("TEMP1EPQ30757450")%>>/
<input id="TEMP1EPQ30757450" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30757450" value =<%=Session ("TEMP1EPQ30757450")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30757600")=1  %>
<tr>
<td>Laryngectomy (removal of larynx or voice box)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30757600" type="text" size= "3" name= "TEMP1EPQ30757600" value =<%=Session ("TEMP1EPQ30757600")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30757600" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30757600" value =<%=Session ("TEMP1EPQ30757600")%>>/
<input id="TEMP1EPQ30757600" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30757600" value =<%=Session ("TEMP1EPQ30757600")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30757750")=1  %>
<tr>
<td>Neck (cervical spine) surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30757750" type="text" size= "3" name= "TEMP1EPQ30757750" value =<%=Session ("TEMP1EPQ30757750")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30757750" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30757750" value =<%=Session ("TEMP1EPQ30757750")%>>/
<input id="TEMP1EPQ30757750" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30757750" value =<%=Session ("TEMP1EPQ30757750")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30757800")=1  %>
<tr>
<td>Sleep apnea surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30757800" type="text" size= "3" name= "TEMP2EPQ30757800" value =<%=Session ("TEMP2EPQ30757800")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30757800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30757800" value =<%=Session ("TEMP2EPQ30757800")%>>/
<input id="TEMP2EPQ30757800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30757800" value =<%=Session ("TEMP2EPQ30757800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30758150")=1  %>
<tr>
<td>AV fistula or graft for hemodialysis</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30758150" type="text" size= "3" name= "TEMP1EPQ30758150" value =<%=Session ("TEMP1EPQ30758150")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30758150" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30758150" value =<%=Session ("TEMP1EPQ30758150")%>>/
<input id="TEMP1EPQ30758150" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30758150" value =<%=Session ("TEMP1EPQ30758150")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30758150")=1  %>
<tr>
<td>Heart transplant</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30758150" type="text" size= "3" name= "TEMPEPQ30758150" value =<%=Session ("TEMPEPQ30758150")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30758150" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30758150" value =<%=Session ("TEMPEPQ30758150")%>>/
<input id="TEMPEPQ30758150" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30758150" value =<%=Session ("TEMPEPQ30758150")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30756550")=1  %>
<tr>
<td>Esophageal dilation (stretching to open the esophagus)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30756550" type="text" size= "3" name= "TEMP1EPQ30756550" value =<%=Session ("TEMP1EPQ30756550")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30756550" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30756550" value =<%=Session ("TEMP1EPQ30756550")%>>/
<input id="TEMP1EPQ30756550" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30756550" value =<%=Session ("TEMP1EPQ30756550")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30756550")=1  %>
<tr>
<td>Laparoscopic esophageal surgery (Nissen fundoplication, Heller myotomy)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30756550" type="text" size= "3" name= "TEMP2EPQ30756550" value =<%=Session ("TEMP2EPQ30756550")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30756550" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30756550" value =<%=Session ("TEMP2EPQ30756550")%>>/
<input id="TEMP2EPQ30756550" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30756550" value =<%=Session ("TEMP2EPQ30756550")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP3EPQ30756550")=1  %>
<tr>
<td>Lung transplant</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP3EPQ30756550" type="text" size= "3" name= "TEMP3EPQ30756550" value =<%=Session ("TEMP3EPQ30756550")%>></td>
<td style="text-align: center;"><input id="TEMP3EPQ30756550" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP3EPQ30756550" value =<%=Session ("TEMP3EPQ30756550")%>>/
<input id="TEMP3EPQ30756550" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP3EPQ30756550" value =<%=Session ("TEMP3EPQ30756550")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30756750")=1  %>
<tr>
<td>Pleurodesis (removal of fluid and sealing of space between chest and lung)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30756750" type="text" size= "3" name= "TEMP1EPQ30756750" value =<%=Session ("TEMP1EPQ30756750")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30756750" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30756750" value =<%=Session ("TEMP1EPQ30756750")%>>/
<input id="TEMP1EPQ30756750" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30756750" value =<%=Session ("TEMP1EPQ30756750")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP3EPQ30756750")=1  %>
<tr>
<td>Removal of a portion of the esophagus containing cancer (esophagogastrectomy)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP3EPQ30756750" type="text" size= "3" name= "TEMP3EPQ30756750" value =<%=Session ("TEMP3EPQ30756750")%>></td>
<td style="text-align: center;"><input id="TEMP3EPQ30756750" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP3EPQ30756750" value =<%=Session ("TEMP3EPQ30756750")%>>/
<input id="TEMP3EPQ30756750" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP3EPQ30756750" value =<%=Session ("TEMP3EPQ30756750")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP4EPQ30756750")=1  %>
<tr>
<td>Removal of lung/portions of the lung (lobectomy, pneumonectomy, wedge resection/segmentectomy)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP4EPQ30756750" type="text" size= "3" name= "TEMP4EPQ30756750" value =<%=Session ("TEMP4EPQ30756750")%>></td>
<td style="text-align: center;"><input id="TEMP4EPQ30756750" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP4EPQ30756750" value =<%=Session ("TEMP4EPQ30756750")%>>/
<input id="TEMP4EPQ30756750" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP4EPQ30756750" value =<%=Session ("TEMP4EPQ30756750")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30756800")=1  %>
<tr>
<td>Robotic-assisted chest surgery (da Vinci surgery) </td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30756800" type="text" size= "3" name= "TEMP1EPQ30756800" value =<%=Session ("TEMP1EPQ30756800")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30756800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30756800" value =<%=Session ("TEMP1EPQ30756800")%>>/
<input id="TEMP1EPQ30756800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30756800" value =<%=Session ("TEMP1EPQ30756800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30756750")=1  %>
<tr>
<td>Thoracoscopic sympathectomy (ETS)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30756750" type="text" size= "3" name= "TEMP2EPQ30756750" value =<%=Session ("TEMP2EPQ30756750")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30756750" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30756750" value =<%=Session ("TEMP2EPQ30756750")%>>/
<input id="TEMP2EPQ30756750" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30756750" value =<%=Session ("TEMP2EPQ30756750")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30756800")=1  %>
<tr>
<td>Thoracoscopy or VATS (a tube with a camera is used to view the lungs and a procedure is performed)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30756800" type="text" size= "3" name= "TEMP2EPQ30756800" value =<%=Session ("TEMP2EPQ30756800")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30756800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30756800" value =<%=Session ("TEMP2EPQ30756800")%>>/
<input id="TEMP2EPQ30756800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30756800" value =<%=Session ("TEMP2EPQ30756800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30758600")=1  %>
<tr>
<td>HoLEP surgery (Holmium Laser Enucleation of the prostate)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30758600" type="text" size= "3" name= "TEMP1EPQ30758600" value =<%=Session ("TEMP1EPQ30758600")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30758600" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30758600" value =<%=Session ("TEMP1EPQ30758600")%>>/
<input id="TEMP1EPQ30758600" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30758600" value =<%=Session ("TEMP1EPQ30758600")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30758650")=1  %>
<tr>
<td>Laser PUP surgery (vaporization of prostate)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30758650" type="text" size= "3" name= "TEMP2EPQ30758650" value =<%=Session ("TEMP2EPQ30758650")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30758650" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30758650" value =<%=Session ("TEMP2EPQ30758650")%>>/
<input id="TEMP2EPQ30758650" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30758650" value =<%=Session ("TEMP2EPQ30758650")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30758800")=1  %>
<tr>
<td>Penile implant</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30758800" type="text" size= "3" name= "TEMP1EPQ30758800" value =<%=Session ("TEMP1EPQ30758800")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30758800" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30758800" value =<%=Session ("TEMP1EPQ30758800")%>>/
<input id="TEMP1EPQ30758800" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30758800" value =<%=Session ("TEMP1EPQ30758800")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30758900")=1  %>
<tr>
<td>Testicular descent surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30758900" type="text" size= "3" name= "TEMP1EPQ30758900" value =<%=Session ("TEMP1EPQ30758900")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30758900" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30758900" value =<%=Session ("TEMP1EPQ30758900")%>>/
<input id="TEMP1EPQ30758900" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30758900" value =<%=Session ("TEMP1EPQ30758900")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30755400")=1  %>
<tr>
<td>Ankle surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30755400" type="text" size= "3" name= "TEMP1EPQ30755400" value =<%=Session ("TEMP1EPQ30755400")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30755400" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30755400" value =<%=Session ("TEMP1EPQ30755400")%>>/
<input id="TEMP1EPQ30755400" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30755400" value =<%=Session ("TEMP1EPQ30755400")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30755400")=1  %>
<tr>
<td>Arm surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30755400" type="text" size= "3" name= "TEMP2EPQ30755400" value =<%=Session ("TEMP2EPQ30755400")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30755400" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30755400" value =<%=Session ("TEMP2EPQ30755400")%>>/
<input id="TEMP2EPQ30755400" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30755400" value =<%=Session ("TEMP2EPQ30755400")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP3EPQ30755400")=1  %>
<tr>
<td>Elbow surgery (Ulnar nerve transposition)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP3EPQ30755400" type="text" size= "3" name= "TEMP3EPQ30755400" value =<%=Session ("TEMP3EPQ30755400")%>></td>
<td style="text-align: center;"><input id="TEMP3EPQ30755400" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP3EPQ30755400" value =<%=Session ("TEMP3EPQ30755400")%>>/
<input id="TEMP3EPQ30755400" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP3EPQ30755400" value =<%=Session ("TEMP3EPQ30755400")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP4EPQ30755400")=1  %>
<tr>
<td>Hip fracture surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP4EPQ30755400" type="text" size= "3" name= "TEMP4EPQ30755400" value =<%=Session ("TEMP4EPQ30755400")%>></td>
<td style="text-align: center;"><input id="TEMP4EPQ30755400" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP4EPQ30755400" value =<%=Session ("TEMP4EPQ30755400")%>>/
<input id="TEMP4EPQ30755400" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP4EPQ30755400" value =<%=Session ("TEMP4EPQ30755400")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP5EPQ30755400")=1  %>
<tr>
<td>Hip replacement</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP5EPQ30755400" type="text" size= "3" name= "TEMP5EPQ30755400" value =<%=Session ("TEMP5EPQ30755400")%>></td>
<td style="text-align: center;"><input id="TEMP5EPQ30755400" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP5EPQ30755400" value =<%=Session ("TEMP5EPQ30755400")%>>/
<input id="TEMP5EPQ30755400" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP5EPQ30755400" value =<%=Session ("TEMP5EPQ30755400")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP6EPQ30755400")=1  %>
<tr>
<td>Hip resurfacing surgery (shaving of bone or hip impingement)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP6EPQ30755400" type="text" size= "3" name= "TEMP6EPQ30755400" value =<%=Session ("TEMP6EPQ30755400")%>></td>
<td style="text-align: center;"><input id="TEMP6EPQ30755400" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP6EPQ30755400" value =<%=Session ("TEMP6EPQ30755400")%>>/
<input id="TEMP6EPQ30755400" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP6EPQ30755400" value =<%=Session ("TEMP6EPQ30755400")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP7EPQ30755650")=1  %>
<tr>
<td>Knee replacement</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP7EPQ30755650" type="text" size= "3" name= "TEMP7EPQ30755650" value =<%=Session ("TEMP7EPQ30755650")%>></td>
<td style="text-align: center;"><input id="TEMP7EPQ30755650" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP7EPQ30755650" value =<%=Session ("TEMP7EPQ30755650")%>>/
<input id="TEMP7EPQ30755650" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP7EPQ30755650" value =<%=Session ("TEMP7EPQ30755650")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP8EPQ30755600")=1  %>
<tr>
<td>Leg surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP8EPQ30755600" type="text" size= "3" name= "TEMP8EPQ30755600" value =<%=Session("TEMP8EPQ30755600")%>></td>
<td style="text-align: center;"><input id="TEMP8EPQ30755600" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP8EPQ30755600" value =<%=Session ("TEMP8EPQ30755600")%>>/
<input id="TEMP8EPQ30755600" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP8EPQ30755600" value =<%=Session ("TEMP8EPQ30755600")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30759050")=1  %>
<tr>
<td>Body contouring</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30759050" type="text" size= "3" name= "TEMPEPQ30759050" value =<%=Session ("TEMPEPQ30759050")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30759050" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30759050" value =<%=Session ("TEMPEPQ30759050")%>>/
<input id="TEMPEPQ30759050" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30759050" value =<%=Session ("TEMPEPQ30759050")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30759200")=1  %>
<tr>
<td>Brow lift</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30759200" type="text" size= "3" name= "TEMPEPQ30759200" value =<%=Session ("TEMPEPQ30759200")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30759200" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30759200" value =<%=Session ("TEMPEPQ30759200")%>>/
<input id="TEMPEPQ30759200" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30759200" value =<%=Session ("TEMPEPQ30759200")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30759450")=1  %>
<tr>
<td>Thigh lift</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30759450" type="text" size= "3" name= "TEMPEPQ30759450" value =<%=Session ("TEMPEPQ30759450")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30759450" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30759450" value =<%=Session ("TEMPEPQ30759450")%>>/
<input id="TEMPEPQ30759450" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30759450" value =<%=Session ("TEMPEPQ30759450")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30759600")=1  %>
<tr>
<td>PIC line</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30759600" type="text" size= "3" name= "TEMPEPQ30759600" value =<%=Session ("TEMPEPQ30759600")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30759600" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30759600" value =<%=Session ("TEMPEPQ30759600")%>>/
<input id="TEMPEPQ30759600" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30759600" value =<%=Session ("TEMPEPQ30759600")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30759700")=1  %>
<tr>
<td>Burning of skin lesion (electrosurgery)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30759700" type="text" size= "3" name= "TEMP1EPQ30759700" value =<%=Session ("TEMP1EPQ30759700")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30759700" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30759700" value =<%=Session ("TEMP1EPQ30759700")%>>/
<input id="TEMP1EPQ30759700" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30759700" value =<%=Session ("TEMP1EPQ30759700")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30759700")=1  %>
<tr>
<td>Chemotherapy creams (Aldara, Carac, Efudex, Fluoroplex, Picato, Solaraze, Zyclara, etc.) </td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30759700" type="text" size= "3" name= "TEMP2EPQ30759700" value =<%=Session ("TEMP2EPQ30759700")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30759700" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30759700" value =<%=Session ("TEMP2EPQ30759700")%>>/
<input id="TEMP2EPQ30759700" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30759700" value =<%=Session ("TEMP2EPQ30759700")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP3EPQ30759700")=1  %>
<tr>
<td>Freezing of skin lesion (cryotherapy)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP3EPQ30759700" type="text" size= "3" name= "TEMP3EPQ30759700" value =<%=Session ("TEMP3EPQ30759700")%>></td>
<td style="text-align: center;"><input id="TEMP3EPQ30759700" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP3EPQ30759700" value =<%=Session ("TEMP3EPQ30759700")%>>/
<input id="TEMP3EPQ30759700" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP3EPQ30759700" value =<%=Session ("TEMP3EPQ30759700")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP4EPQ30755300")=1  %>
<tr>
<td>Mole removal</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP4EPQ30755300" type="text" size= "3" name= "TEMP4EPQ30755300" value =<%=Session ("TEMP4EPQ30755300")%>></td>
<td style="text-align: center;"><input id="TEMP4EPQ30755300" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP4EPQ30755300" value =<%=Session ("TEMP4EPQ30755300")%>>/
<input id="TEMP4EPQ30755300" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP4EPQ30755300" value =<%=Session ("TEMP4EPQ30755300")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP5EPQ30755300")=1  %>
<tr>
<td>Skin flap surgery (skin repositioned to the wound)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP5EPQ30755300" type="text" size= "3" name= "TEMP5EPQ30755300" value =<%=Session ("TEMP5EPQ30755300")%>></td>
<td style="text-align: center;"><input id="TEMP5EPQ30755300" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP5EPQ30755300" value =<%=Session ("TEMP5EPQ30755300")%>>/
<input id="TEMP5EPQ30755300" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP5EPQ30755300" value =<%=Session ("TEMP5EPQ30755300")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP6EPQ30755300")=1  %>
<tr>
<td>Skin graft (skin relocated to the wound)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP6EPQ30755300" type="text" size= "3" name= "TEMP6EPQ30755300" value =<%=Session ("TEMP6EPQ30755300")%>></td>
<td style="text-align: center;"><input id="TEMP6EPQ30755300" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP6EPQ30755300" value =<%=Session ("TEMP6EPQ30755300")%>>/
<input id="TEMP6EPQ30755300" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP6EPQ30755300" value =<%=Session ("TEMP6EPQ30755300")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP1EPQ30759950")=1  %>
<tr>
<td>Back joint injections or nerve blocks</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP1EPQ30759950" type="text" size= "3" name= "TEMP1EPQ30759950" value =<%=Session ("TEMP1EPQ30759950")%>></td>
<td style="text-align: center;"><input id="TEMP1EPQ30759950" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP1EPQ30759950" value =<%=Session ("TEMP1EPQ30759950")%>>/
<input id="TEMP1EPQ30759950" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP1EPQ30759950" value =<%=Session ("TEMP1EPQ30759950")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP2EPQ30759950")=1  %>
<tr>
<td>Pain pump or spinal cord stimulator</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP2EPQ30759950" type="text" size= "3" name= "TEMP2EPQ30759950" value =<%=Session ("TEMP2EPQ30759950")%>></td>
<td style="text-align: center;"><input id="TEMP2EPQ30759950" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP2EPQ30759950" value =<%=Session ("TEMP2EPQ30759950")%>>/
<input id="TEMP2EPQ30759950" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP2EPQ30759950" value =<%=Session ("TEMP2EPQ30759950")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP3EPQ30759950")=1  %>
<tr>
<td>Spinal fusion (kyphoplasty, where bone cement is injected for fractures)</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP3EPQ30759950" type="text" size= "3" name= "TEMP3EPQ30759950" value =<%=Session ("TEMP3EPQ30759950")%>></td>
<td style="text-align: center;"><input id="TEMP3EPQ30759950" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP3EPQ30759950" value =<%=Session ("TEMP3EPQ30759950")%>>/
<input id="TEMP3EPQ30759950" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP3EPQ30759950" value =<%=Session ("TEMP3EPQ30759950")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP4EPQ30759950")=1  %>
<tr>
<td>Spine surgery</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP4EPQ30759950" type="text" size= "3" name= "TEMP4EPQ30759950" value =<%=Session ("TEMP4EPQ30759950")%>></td>
<td style="text-align: center;"><input id="TEMP4EPQ30759950" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP4EPQ30759950" value =<%=Session ("TEMP4EPQ30759950")%>>/
<input id="TEMP4EPQ30759950" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP4EPQ30759950" value =<%=Session ("TEMP4EPQ30759950")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMP5EPQ30759950")=1  %>
<tr>
<td>Steroid injections to back</td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMP5EPQ30759950" type="text" size= "3" name= "TEMP5EPQ30759950" value =<%=Session ("TEMP5EPQ30759950")%>></td>
<td style="text-align: center;"><input id="TEMP5EPQ30759950" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMP5EPQ30759950" value =<%=Session ("TEMP5EPQ30759950")%>>/
<input id="TEMP5EPQ30759950" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMP5EPQ30759950" value =<%=Session ("TEMP5EPQ30759950")%>></td>
</tr>
<% end if %>
<% end if %>
...
<% session("DisplayCount") = Session("DisplayCount") +1 %>
<% session("TEMPEPQ30760250")=1  %>
<tr>
<td>Other spine surgery, specify: <%=Session("TEMPEPQ30760290Describe")%></td>
<td style="text-align: center;"><input class="howMany required" maxlength="3"  id="TEMPEPQ30760250" type="text" size= "3" name= "TEMPEPQ30760250" value =<%=Session ("TEMPEPQ30760250")%>></td>
<td style="text-align: center;"><input id="TEMPEPQ30760250" type="text" class="dateMonth" maxlength="2" size= "3" name= "TEMPEPQ30760250" value =<%=Session ("TEMPEPQ30760250")%>>/
<input id="TEMPEPQ30760250" class="yearRange required" maxlength="4" type="text" size= "4" name= "TEMPEPQ30760250" value =<%=Session ("TEMPEPQ30760250")%>></td>
</tr>
<% end if %>
<% end if %>

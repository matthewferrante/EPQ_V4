...
<div id="formBlock">
    ...
    <form action="pastmedical14b3.asp" method="post" id="formQuestion" name="formQuestion">
...
<br>
  <fieldset>
    <legend class="QuestionBox">
      What age or year were you first diagnosed with chronic obstructive pulmonary disease (COPD)?<br>
	  </legend>

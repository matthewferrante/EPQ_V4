...
<!-- [Question boxes ] -->		
    ...
    <legend class="QuestionBox">
      Have you had any of the following skin symptoms in the past 3 months? Check all that apply.<br>
	  </legend>
...
<span class="column2">
		...
		<label for="EPQ30507040">Mole that was new after age 40</label><br>

		<input type="checkbox" name="EPQ30507020" value="1" id="EPQ30507020" <%=strEPQ30507020answer1%>>
		<label for="EPQ30507020">Sore that does not heal</label><br>

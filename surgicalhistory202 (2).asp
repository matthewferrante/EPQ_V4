...
<input type="checkbox" class="atLeastOneCheckboxRequired"name="EPQ30755950" value="1" <%=strEPQ30755950answer1%>>Axillary node dissection (or lymph node removal)<br>
		...
		<input type="checkbox" class="atLeastOneCheckboxRequired"name="TEMP1EPQ30756100b" value="1" <%=strTEMP1EPQ30756100banswer1%>>Breast reconstruction with abdominal flap<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(DIEP, Pedicle TRAM, Free TRAM) <br>
		<input type="checkbox" class="atLeastOneCheckboxRequired"name="TEMP2EPQ30756100b" value="1" <%=strTEMP2EPQ30756100banswer1%>>Breast reconstruction with back flap<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;only (latissimus dorsi flap)<br>
		<input type="checkbox" class="atLeastOneCheckboxRequired"name="TEMP3EPQ30756100b" value="1" <%=strTEMP3EPQ30756100banswer1%>>Breast reconstruction with expanders,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 then implants<br>
		<input type="checkbox" class="atLeastOneCheckboxRequired"name="TEMP4EPQ30756100b" value="1" <%=strTEMP4EPQ30756100banswer1%>>Breast reconstruction with implants<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(no expanders)<br>
		<input type="checkbox" class="atLeastOneCheckboxRequired"name="TEMP5EPQ30756100b" value="1" <%=strTEMP5EPQ30756100banswer1%>>Breast reconstruction with<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fat grafting<br>
	<input type="checkbox"  class="atLeastOneCheckboxRequired"name="TEMP6EPQ30756100b" value="1" <%=strTEMP6EPQ30756100banswer1%>>Breast reconstruction with  SGAP/IGAP<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(gluteal flaps)<br>
		<input type="checkbox"  class="atLeastOneCheckboxRequired"name="TEMP7EPQ30756100b" value="1" <%=strTEMP7EPQ30756100banswer1%>>Breast reconstruction with TUG or  PAP<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (thigh flaps)<br>
		<input type="checkbox"  class="atLeastOneCheckboxRequired"name="TEMP8EPQ30756100b" value="1" <%=strTEMP8EPQ30756100banswer1%>>Breast reconstruction other  types<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;of breast reconstruction<br>
...
<span class="column2">
		...
		<input type="checkbox"  class="atLeastOneCheckboxRequired"name="TEMP1EPQ30756250" value="1" <%=strTEMP1EPQ30756250answer1%>>Cyst removal<br>

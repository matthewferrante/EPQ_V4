...
<div id="formBlock">
    ...
    <form action="currentsymptoms16b.asp" method="post" id="formQuestion" name="formQuestion">
...
<!-- [Question boxes ] -->		
  ...
  <legend class="QuestionBox">
    Have you had any kidney or bladder related problems in the past 3 months? (Mark all that apply)<br>
	</legend>
...
<span class="column1">
		...
		<label for="EPQ30521040">Urine leaking (incontinence)</label><br>
		<input type="checkbox" name="EPQ30521050" value="1" id="EPQ30521050" <%=strEPQ30521050answer1%>>
		<label for="EPQ30521050">Sensation of not emptying bladder completely after you finished urinating</label><br>
...
<span class="column2">
		...
		<input type="checkbox" name="EPQ30521110" value="1" id="EPQ305211100" <%=strEPQ30521110answer1%>>
		...
		<input type="checkbox" name="EPQ30521170" value="1" id="EPQ305211170" <%=strEPQ30521170answer1%>>
		<label for="EPQ30521170">Foul smelling urine</label><br>
		<input type="checkbox" name="EPQ30521180" value="1" id="EPQ305211180" <%=strEPQ30521180answer1%>>
	...
	<input id="EPQ30521000" type="text" maxlength="75" size="15" name="EPQ30521000" value=<%=Session("EPQ30521000")%>><br>
		<input type="radio" name="EPQ30521200" value="1" id="EPQ30521200" <%=strEPQ3052200answer1%>>

...
displayLocation.add "MBST", "Melanoma, Brain, and Spinal Tumor Clinic"	
displayLocation.add "BRST", "Breast clinic"	
displayLocation.add "BRS1", "Breast clinic"	
...
displayLocation.add "CP", "Cancer Prevention"	
displayLocation.add "MSMO", "MED ONC SOUTH"
displayLocation.add "MSMS", "MED SURG SOUTH"
displayLocation.add "MSP", "SCREENING AND PREVENTION"	
...
displayLocation.add "SP", "SCREENING AND PREVENTION"	
...
displayLocation.add "SUPP", "SUPPORTIVE CARE MEDICINE"	
displayLocation.add "BEH", "BEHAVIORAL MEDICINE"		
displayLocation.add "CRDO", "CARDIO ONCOLOGY"
displayLocation.add "",""
...
if Request.Form("ispostback") = 1 then
	...
	Session("strAPpointmentID")="19178874.000"
  ...
  ' TODO move these into init function below
	  ...
	  initializeModuleStatusRecords(Session("strAppointmentID"))
...
<div id="formWrapper">
<div id="formBlock">
	<div id="SpecialNote">Find Your Appointment</div>
    <form action="kioskpageconfirm.asp" method="post" id="formQuestion" name="formQuestion">
			<!-- [ ' Values are filled in in the OnAnswerQuestion function above. ] -->
			<input type="hidden" name="ContinueID" value="1" id="Hidden1">
...
<fieldset>
      ...
      <div class="QuestionBox">Is this information correct for your appointment?</div>
<legend></legend>
      ...
      Your Name: <b><%=Session("strLastName")%> , <%=Session("FirstName")%></b><BR>
      Your Medical Record Number (MRN): <b><%=Session("AccountNumber") %><br></b>
<%=Session("strAppointmentID")%>
      <BR>
      Your Location: <b><%=displayLocation.item(Session("AppointmentLocation"))%></b><BR>

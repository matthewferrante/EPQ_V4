...
if Session("EPQ30311010Page3")= "1" then 
...
if session("EPQ30311011Page3")=1 then
...
if session("EPQ30311012Page3")=1 then
...
if session("EPQ30311013Page3")=1 then
...
if session("EPQ30311014Page3")=1 then
...
if session("EPQ30311015Page3")=1 then
...
if session("EPQ30311016Page3")=1 then
...
if session("EPQ30311017Page3")=1 then
...
if session("EPQ30311018Page3")=1 then
...
if session("EPQ30311019Page3")=1 then
...
if session("EPQ30311020Page3")=1 then
...
if session("EPQ30311021Page3")=1 then
...
if session("EPQ30311022Page3")=1 then
...
if session("EPQ30311023Page3")=1 then
...
if session("EPQ30311024Page3")=1 then
...
if session("EPQ30311025Page3")=1 then
...
if session("EPQ30311026Page3")=1 then
...
if session("EPQ30311027Page3")=1 then
...
if session("EPQ30311028Page3")=1 then
...
if session("EPQ30311029Page3")=1 then
...
if session("EPQ30311030Page3")=1 then
...
if session("EPQ30311031Page3")=1 then
...
if session("EPQ30311032Page3")=1 then
...
if session("EPQ30311033Page3")=1 then
...
if session("EPQ30311034Page3")=1 then
...
if session("EPQ30311035Page3")=1 then
...
if session("EPQ30311036Page3")=1 then
...
if session("EPQ30311037Page3")=1 then
...
if session("EPQ30311038Page3")=1 then
...
if session("EPQ30311039Page3")=1 then
...
if Request.Form("ContinueID")="1" then
	...
	if Session("PHCDisplayCounter") > 24 then 
	Session("Page")="33"
	Response.Redirect "personalhistorycancermaster.asp"
	end if
...
Please provide the age when you had these type(s) of cancer and treatment(s) received.
    ...
    <form action="personalhistorycancer32.asp" method="post" id="formQuestion" name="formQuestion">
...
<%if session("EPQ30311011Page3")=1 then%>
	<tr>
		...
		<td style="text-align: center;"><input id="EPQ30313000" class="age" type="text" class="required yearsExposed" size="3" maxlength="3" name="EPQ30313000" value=<%=Session("EPQ30313000")%>><br></td>
...
<%if session("EPQ30311035Page3")=1 then%>
	...
	<tr>
		<td>
Skin cancer other&nbsp;<br> than melanoma 
		</td>
		<td style="text-align: center;">

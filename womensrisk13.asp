...
if Request.Form("ispostback") <> "1" then
	...
	if Session("TEMPEPQ30618006")="1" then
		strTEMPEPQ30618006answer1="checked"
	end if
	...
	if Session("TEMPEPQ30618011")="1" then
		strTEMPEPQ30618011answer1="checked"
	end if
...
if Request.Form("ispostback")="1" then
	...
	Session("TEMPEPQ30618006") = Request.Form("TEMPEPQ30618006")
	...
	Session("TEMPEPQ30618011") = Request.Form("TEMPEPQ30618011")
	Session("EPQ30618012") = Request.Form("EPQ30618012")
	Session("TEMPEPQ30610009")=Request.Form("TEMPEPQ30610009")
...
Please check what non-hormonal birth control you are <u>currently</u> using. Check all that apply.<br>
	</legend>

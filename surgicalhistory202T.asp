...
<fieldset><legend></legend>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" class="atLeastOneIfBranchActive"name="TEMP2EPQ30756100b" value="1" <%=strTEMP2EPQ30756100banswer1%>>With back flap only (latissimus dorsi flap)<br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"  class="atLeastOneIfBranchActive"name="TEMP6EPQ30756100b" value="1" <%=strTEMP6EPQ30756100banswer1%>>With SGAP or IGAP (gluteal flaps)<br>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"  class="atLeastOneIfBranchActive"name="TEMP9EPQ30756100b" value="1" <%=strTEMP8EPQ30756100banswer1%>>Unknown<br>
</fieldset>
</div>

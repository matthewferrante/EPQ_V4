...
if Request.Form("ContinueID")="1" then
	if len(Session("EPQ31009000")) = 0 then 
		 <!--#include file="questionscomplete.asp"-->
	else 
	end if
	if len(Session("EPQ31010000")) = 0 then 
		 <!--#include file="questionscomplete.asp"-->
	else 
	end if
...
<br>A <u>Colonoscopy</u> is a similar exam but it uses a longer tube to examine the entire colon.  Before a colonoscopy is done, you need to clean out your entire colon and you are usually given medication through a needle in you arm to make you sleepy during the test.<BR>
    ...
    <form action="cancerscreening3.asp" method="post" id="formQuestion" name="formQuestion">
...
What was this MOST RECENT exam called? (PLEASE MARK THE APPROPRIATE EXAM)<br>
	...
	<div class="QuestionAnswersBox">
		<input type="radio" name="EPQ31011000" value="1" id="EPQ31011000" <%=strEPQ31011000answer2%>>
		<label for="EPQ31011000">Colonoscopy</label>
		<input type="radio" name="EPQ31011000" value="2" id="EPQ31011000" <%=strEPQ31011000answer1%>>
		<label for="EPQ31011000">Sigmoidoscopy</label>
		<input type="radio" name="EPQ31011000" value="3" id="EPQ31011000" <%=strEPQ31011000answer3%>>
		<label for="EPQ31011000">Something else (SPECIFY:)</label>
<input id="EPQ31011000specify" type="text" size="25" name="EPQ31011000specify" value=<%=Session("EPQ31011000specify")%>>

...
<div id="formBlock">
    ...
    <form action="pastmedical10a.asp" method="post" id="formQuestion" name="formQuestion">
	...
	<div class="tableFamilyHistory">
		<table class="dataTable" cellspacing="0" rules="groups">
		  ...
		  <colgroup></colgroup>
			...
			<tr>
				<th colspan="1">Did a doctor ever say that you had any of the following problems involving your pancreas?</th>

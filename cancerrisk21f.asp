...
<div id="formBlock">
    ...
    <form action="cancerrisk21f.asp" method="post" id="formQuestion" name="formQuestion">
...
<!-- [Question boxes ] -->		
  <fieldset>
    <legend class="QuestionBox">
      At what age did you begin taking Metformin/Glucophage?<br>
	  </legend>
	<div class="QuestionAnswersBox">
		<label for="EPQ30407280">at age: </label>
  ...
  <fieldset>
    <legend class="QuestionBox">
      Are you currently taking Metformin/Glucophage?<br>
	  </legend>
	<div class="QuestionAnswersBox">
  ...
  <fieldset>
		<!-- label for="EPQ30407200">How many years in total did you take Metformin/Glucophage? -->
    <legend class="QuestionBox">
		  How many years in total did you take Metformin/Glucophage?<br>
	  </legend>
	<div class="QuestionAnswersBox">

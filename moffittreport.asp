...
strpayload=strpayload & " \par "
		...
		strPayload=strPayload&"\ulnone\b\fs24 Non-Cancer Diagnoses1 \ulnone\b0\fs20\ \par "
%>
<!--#include file="moffittreporttemp3.asp"-->
<%
...
if len(Session("EPQ30754020"))<1 then 
strPayload2=strPayload2&" \tab\tab "&Session("EPQ30754030")&" \par "
else

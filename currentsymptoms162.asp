...
<!-- [Question boxes ] -->		
    ...
    <legend class="QuestionBox">
      Have you had any kidney or bladder related symptoms in the past 3 months? Check all that apply.<br>
	  </legend>
	<div class="QuestionAnswersBox">
<span class="column1">
		<input type="checkbox" name="EPQ30521160" value="1" id="EPQ30521160" <%=strEPQ30521160answer1%>>
		<label for="EPQ30521160">Blood or blood clots in urine</label><br>

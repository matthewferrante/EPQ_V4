...
if Request.Form("ispostback") <> "1" then
	...
	if Session("TEMP1EPQ30506060")="1" then
		strTEMP1EPQ30506060answer1="checked"
	end if
	if Session("TEMP2EPQ30506060")="1" then
		strTEMP2EPQ30506060answer1="checked"
	end if
...
if Request.Form("ispostback")="1" then
	...
	Session("TEMP1EPQ30506060") = Request.Form("TEMP1EPQ30506060")
	Session("TEMP2EPQ30506060") = Request.Form("TEMP2EPQ30506060")
...
<!-- [Question boxes ] -->		
<div id="SpecialNote">
In the previous section, we asked you about medical problems, diseases, and conditions a doctor said you had.   In this section, we are interested in symptoms you have experienced in the past three months.
</div>

	<fieldset class="eitherNoneOrChecked">
    <legend class="QuestionBox">
      Have you had any health symptoms in the past 3 months? Check all that apply.<br>
	  </legend>
	<div class="QuestionAnswersBox">
		...
		<input type="checkbox" name="TEMP1EPQ30506060" value="1" id="TEMP1EPQ30506060" <%=strTEMP1EPQ30506060answer1%>>
		<label for="EPQ30506060">Unintended weight gain of 10 pounds or more</label><br>
		<input type="checkbox" name="TEMP2EPQ30506060" value="1" id="TEMP2EPQ30506060" <%=strTEMP2EPQ30506060answer1%>>
		<label for="EPQ30506060">Unintended weight loss of 10 pounds or more</label><br>

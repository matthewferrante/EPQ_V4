...
if Request.Form("ispostback") <> "1" then
	...
	if Session("EPQ30701010")="1" then
		strEPQ30701010yes="checked"
	end if
	if Session("EPQ30701010")="0" then
		strEPQ30701010no="checked"
	end if
	if Session("EPQ30701010")="77" then
		strEPQ30701010answer3="checked"
	end if
end if
	

if Request.Form("ispostback")="1" then
	Session("EPQ30701010string")= ""

	Session("EPQ30701010") = Request.Form("EPQ30701010")
...
if Request.Form("ContinueID")="1" then
	if len(Session("EPQ30701010")) = 0 then 
...
<div id="formBlock">
    ...
    <form action="surgicalhistory2.asp" method="post" id="formQuestion" name="formQuestion">
...
Have you ever had a surgery, biopsy, or a medical procedure including when you were a baby or child? This includes cesarean sections, D&Cs, cardiac catheterizations, eye surgeries, colonoscopy, and plastic surgeries. <br>
	</legend>
	<div class="QuestionAnswersBox">
		<input type="radio" name="EPQ30701010" value="1" id="EPQ307010101" class="required" <%=strEPQ30701010yes%>>
		<label for="EPQ307010101">Yes</label><br>
		<input type="radio" name="EPQ30701010" value="0" id="EPQ307010102" <%=strEPQ30701010no%>>
		<label for="EPQ307010102">No</label><br>
	</div><!-- [ /#AnswerBox] --> 
  </fieldset>
</div> <!-- [ /#formBlock ] -->

...
<div id="formBlock">
    ...
    <form action="cancerrisk17.asp" method="post" id="formQuestion" name="formQuestion">
...
During your entire life, have you smoked at least 100 cigarettes, which is about 5 packs of cigarettes?<br>
	...
	<div class="QuestionAnswersBox">
		...
		<label for="EPQ311470003">Don't Know/Not Sure</label><br>
	</div><!-- [ /#AnswerBox] -->
  </fieldset>
...
How long has it been since you last smoked cigarettes regularly?<br>
	...
	<div class="QuestionAnswersBox">
		...
		<label for="EPQ311490001">Within the past month (less than 1 month ago)</label><br>
		<input type="radio" name="EPQ31149000" value="2" id="EPQ311490002" <%=strEPQ31149000answer2%>>
		<label for="EPQ311490002">Within the past 3 months (1 month but less than 3 months ago)</label><br>
		<input type="radio" name="EPQ31149000" value="3" id="EPQ311490003" <%=strEPQ31149000answer3%>>
		<label for="EPQ311490003">Within the past 6 months (3 months but less than 6 months ago)</label><br>
		<input type="radio" name="EPQ31149000" value="4" id="EPQ311490004" <%=strEPQ31149000answer4%>>
		<label for="EPQ311490004">Within the past year (6 months but less than 1 year ago)</label><br>
		<input type="radio" name="EPQ31149000" value="5" id="EPQ311490005" <%=strEPQ31149000answer5%>>
		<label for="EPQ311490005">Within the past 5 years (1 year but less than 5 years ago)</label><br>
		<input type="radio" name="EPQ31149000" value="6" id="EPQ311490006" <%=strEPQ31149000answer6%>>
		<label for="EPQ311490006">Within the past 10 years (5 years but less than 10 years ago)</label><br>

...
What was the reason your periods stopped?<br>
	...
	<div class="QuestionAnswersBox">
		<input type="radio" name="EPQ30606000" class="required" value="1" id="EPQ306060001" <%=strEPQ30606000answer1%>>
		<label for="EPQ306060001">Natural menopause (change of life)</label><br>

		<input type="radio" name="EPQ30606000" value="2" id="EPQ306060002" <%=strEPQ30606000answer2%>>
		<label for="EPQ306060002">Because of hysterectomy or removal of ovaries (or both)</label><br>

		<input type="radio" name="EPQ30606000" value="5" id="EPQ306060005" <%=strEPQ30606000answer5%>>
		<label for="EPQ306060005">I have been pregnant or breastfeeding and they stopped temporarily.</label><br>

		<input type="radio" name="EPQ30606000" value="6" id="EPQ306060006" <%=strEPQ30606000answer6%>>
		<label for="EPQ306060006">I take birth control that stopped my period temporarily.</label><br>

		<input type="radio" name="EPQ30606000" value="3" id="EPQ306060003" <%=strEPQ30606000answer3%>>
		<label for="EPQ306060003">I took medication that permanently stopped my period, including treatment for cancer.</label><br>
		<input type="radio" name="EPQ30606000" value="4" id="EPQ30606004" <%=strEPQ30606000answer4%>>
...
How old were you when your periods stopped completely?<br>
	...
	<div class="QuestionAnswersBox">
		<input id="EPQ30607000" type="text" size="2" maxlength="2" name="EPQ30607000" class="yearsExposed required" value=<%=Session("EPQ30607000")%>>

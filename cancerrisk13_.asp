...
<div id="formBlock">
    ...
    <form action="cancerrisk13.asp" method="post" id="formQuestion" name="formQuestion">
...
During the past 12 months, have you seen a professional provider, licensed practitioner or therapist for<br> any of the following for your own health? Check all that apply. <br>
	</legend>

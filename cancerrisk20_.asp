...
<div id="formBlock">
    ...
    <form action="cancerrisk20.asp" method="post" id="formQuestion" name="formQuestion">
...
During the past 12 months, have you seen a professional provider, licensed practitioner or therapists for any of the following for your own health? (Mark all that apply). <br>
	</legend>
	<div class="QuestionAnswersBox">
		...
		<label for="EPQ31141070">Fold Medicine (for example, Curanderismo or Native American healing</label><br>
		...
		<label for="EPQ31141100">Naturopathy</label><br>
		<input type="radio" name="EPQ31141110" value="1" id="EPQ31141110" <%=strEPQ31141110answer1%>>
		<label for="EPQ31141110">None of there</label><br>

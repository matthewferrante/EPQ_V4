...
Are you currently pregnant?<br>
	</legend>
	<div class="QuestionAnswersBox">
		<input type="radio" name="TEMPEPQ30619000" value="1" id="EPQ306190001" class="required" <%=strEPQ30619000answer1%>>
		<label for="EPQ306190001">Yes</label><br>
		<input type="radio" name="TEMPEPQ30619000" value="0" id="EPQ306190002" <%=strEPQ30619000answer2%>>
		<label for="EPQ306190002">No</label><br>
		<input type="radio" name="TEMPEPQ30619000" value="88" id="EPQ306190002" <%=strEPQ30619000answer2%>>
		<label for="EPQ306190002">Not sure</label>
	</div><!-- [ /#AnswerBox] --> 
  </fieldset>
	...
	<fieldset>
  <legend class='QuestionBox'>
Have you ever been pregnant before? (Please include all miscarriages and abortions as well as full-term pregnancies)<br>
	</legend>
	<div class="QuestionAnswersBox">
		<input type="radio" name="EPQ30619000" value="1" id="EPQ30619000" class="required" <%=strEPQ30619000answer1%>>
		<label for="EPQ306190001">Yes</label><br>
		<input type="radio" class="required" name="EPQ30619000" value="0" id="EPQ30619000" <%=strEPQ30619000answer2%>>
		<label for="EPQ30619000">No</label>
	</div><!-- [ /#AnswerBox] --> 
  </fieldset>

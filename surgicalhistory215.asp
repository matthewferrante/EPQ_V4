...
Session.Contents.Remove("TEMP1EPQ30756250N")
Session.Contents.Remove("TEMP1EPQ30756250MM")
Session.Contents.Remove("TEMP1EPQ30756250YY")
end if
...
Session.Contents.Remove("EPQ30514040N")
Session.Contents.Remove("EPQ30514040MM")
Session.Contents.Remove("EPQ30514040YY")
end if

if Session("EPQ30755090")<> "1" then
Session.Contents.Remove("EPQ30755090N")
Session.Contents.Remove("EPQ30755090MM")
Session.Contents.Remove("EPQ30755090YY")
end if
if Session("EPQ30755100")<> "1" then
Session.Contents.Remove("EPQ30755100N")
Session.Contents.Remove("EPQ30755100MM")
Session.Contents.Remove("EPQ30755100YY")
end if
if Session("TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("TEMP14EPQ30514030N")
Session.Contents.Remove("TEMP14EPQ30514030MM")
Session.Contents.Remove("TEMP14EPQ30514030YY")
end if
if Session("1TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("1TEMP14EPQ30514030N")
Session.Contents.Remove("1TEMP14EPQ30514030MM")
Session.Contents.Remove("1TEMP14EPQ30514030YY")
end if
...
if Session("2TEMPEPQ30514030Page1")<> "1" then
Session.Contents.Remove("2TEMPEPQ30514030N")
Session.Contents.Remove("2TEMPEPQ30514030MM")
Session.Contents.Remove("2TEMPEPQ30514030YY")
end if
if Session("4TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("4TEMP14EPQ30514030N")
Session.Contents.Remove("4TEMP14EPQ30514030MM")
Session.Contents.Remove("4TEMP14EPQ30514030YY")
end if
if Session("5TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("5TEMP14EPQ30514030N")
Session.Contents.Remove("5TEMP14EPQ30514030MM")
Session.Contents.Remove("5TEMP14EPQ30514030YY")
end if

if Session("7TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("7TEMP14EPQ30514030N")
Session.Contents.Remove("7TEMP14EPQ30514030MM")
Session.Contents.Remove("7TEMP14EPQ30514030YY")
end if

if Session("8TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("8TEMP14EPQ30514030N")
Session.Contents.Remove("8TEMP14EPQ30514030MM")
Session.Contents.Remove("8TEMP14EPQ30514030YY")
end if

if Session("9TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("9TEMP14EPQ30514030N")
Session.Contents.Remove("9TEMP14EPQ30514030MM")
Session.Contents.Remove("9TEMP14EPQ30514030YY")
end if

if Session("10TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("10TEMP14EPQ30514030N")
Session.Contents.Remove("10TEMP14EPQ30514030MM")
Session.Contents.Remove("10TEMP14EPQ30514030YY")
end if

if Session("11TEMP14EPQ30514030")<> "1" then
Session.Contents.Remove("11TEMP14EPQ30514030N")
Session.Contents.Remove("11TEMP14EPQ30514030MM")
Session.Contents.Remove("11TEMP14EPQ30514030YY")
end if

if Session("TEMP16EPQ30514090")<> "1" then
Session.Contents.Remove("TEMP16EPQ30514090")
Session.Contents.Remove("TEMP16EPQ30514090")
Session.Contents.Remove("TEMP16EPQ30514090")
end if

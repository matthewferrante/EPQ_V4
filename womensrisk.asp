...
if Request.Form("ispostback") <> "1" then
	...
	if Session("EPQ31001000")="1" then
		strEPQ31001000answer1="checked"
	end if
	if Session("EPQ31001000")="0" then
		strEPQ31001000answer2="checked"
	end if
	if Session("EPQ31001000")="88" then
		strEPQ31001000answer3="checked"
	end if
...
Has a doctor or health care provider ever <u>recommended</u> that you have a skin exam?<br>
	</legend>
	<div class="QuestionAnswersBox">
		<input type="radio" name="EPQ31001000" value="1" id="EPQ31001000" <%=strEPQ31001000answer1%>>
		<label for="EPQ31001000">Yes</label>
		<input type="radio" name="EPQ31001000" value="0" id="EPQ31001000" <%=strEPQ31001000answer2%>>
		<label for="EPQ31001000">No</label>
		<input type="radio" name="EPQ31001000" value="88" id="EPQ31001000" <%=strEPQ31001000answer3%>>
		<label for="EPQ31001000">Don't know</label><br>
...
Have you EVER HAD a skin exam?<br>
	...
	<div class="QuestionAnswersBox">
		<input type="radio" name="EPQ31002000" value="1" id="EPQ31002000" <%=strEPQ31002000answer1%>>
		<label for="EPQ31002000">Yes</label>
		<input type="radio" name="EPQ31002000" value="0" id="EPQ31002000" <%=strEPQ31002000answer2%>>
		<label for="EPQ31002000">No</label>
		<input type="radio" name="EPQ31002000" value="88" id="EPQ31002000" <%=strEPQ31002000answer3%>>
...
&nbsp;&nbsp;&nbsp; Year: <input id="EPQ31003000YY" type="text" size="5" name="EPQ31003000YY" value=<%=Session("EPQ31003000YY")%>>
	...
	<fieldset><legend class='QuestionBox'>
How many skin exams have you had in the LAST 5 YEARS?<br>
	</legend>
	<div class="QuestionAnswersBox">

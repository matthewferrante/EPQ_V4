...
<!-- [Question boxes ] -->		
    ...
    <legend class="QuestionBox">
      Have you had any of the following breast problems in the past three months? Check all that apply.<br>
	  </legend>
	<div class="QuestionAnswersBox">
<span class="column1">
		<input type="checkbox" name="EPQ30508010" value="1" id="EPQ30508010" <%=strEPQ30508010answer1%>>
		<label for="EPQ30508010">A new lump or breast mass</label><br>
		<input type="checkbox" name="EPQ30508030" value="1" id="EPQ30508030" <%=strEPQ30508030answer1%>>
		<label for="EPQ30508030">A lump in your armpit or under your arm</label><br>
<% if session("Gender")="F" then %>
		<input type="checkbox" name="EPQ30508100" value="1" id="EPQ30508100" <%=strEPQ30508100answer1%>>
		<label for="EPQ30508100">Abnormal mammogram</label><br>
<% end if %>
		...
		<label for="EPQ30508020">Changes in a lump or breast mass</label><br>

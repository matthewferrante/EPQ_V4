...
<div id="formBlock">
    ...
    <form action="demographics5.asp" method="post" id="formQuestion" name="formQuestion">
...
<!-- [Question boxes ] -->
  ...
  <fieldset>
    ...
    <div class="QuestionAnswersBox">
      <input type="radio" name="EPQ30102000" value="1" id="EPQ30102000Y" class="required qTrigger" <%=strEPQ30102000yes%>>
      <label for="EPQ30102000Y">Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="radio" class="required qTriggerOff" name="EPQ30102000" value="0" id="EPQ30102000N" <%=strEPQ30102000no%>>
...
<div class="hiddenQ">
  ...
  <fieldset>
    <legend class="QuestionBox">
      Which group or groups best represent your Hispanic or Latino heritage? Check all that apply. <br>
    </legend>
    <div class="QuestionAnswersBox">
      <input type="checkbox" class="eitherNoneOrCheckedIfBranchActive"  name="EPQ30103010" value="1"  id="EPQ30103010" <%=strEPQ30103010answer1%>>
      <label for="EPQ30103010">Puerto Rican</label><br>

      <input type="checkbox" name="EPQ30103020" value="1" 	 id="EPQ30103020" <%=strEPQ30103020answer1%>>
      <label for="EPQ30103020">Cuban</label><br>

      <input type="checkbox" name="EPQ30103030" value="1"  id="EPQ30103030" <%=strEPQ30103030answer1%>>
      <label for="EPQ30103030">Dominican (Republic)</label><br>

      <input type="checkbox" name="EPQ30103040" value="1" id="EPQ30103040" <%=strEPQ30103040answer1%>>
      <label for="EPQ30103040">Mexican, Mexican American, or Chicano</label><br>

      <input type="checkbox" name="EPQ30103050" value="1"  id="EPQ30103050" <%=strEPQ30103050answer1%>>
      <label for="EPQ30103050">Central or South American, other than Brazilian</label><br>

      <input type="checkbox" name="EPQ30103060" value="1"  id="EPQ30103060" <%=strEPQ30103060answer1%>>
      ...
      <input type="radio" name="EPQ30103070" value="1"  id="EPQ30103070" <%=strEPQ30103070answer1%>>

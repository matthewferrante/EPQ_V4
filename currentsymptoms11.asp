...
<!-- [Question boxes ] -->		
    ...
    <legend class="QuestionBox">
      Have you had any mental health or emotional symptoms in the past 3 months? Check all that apply.<br>
	  </legend>
...
<span class="column2">
		...
		<label for="EPQ30516070">Sleeping difficulties or insomnia</label><br>

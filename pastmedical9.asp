...
if Request.Form("ispostback")="1" then
	...
	Session("TEMPEPQ30407120") = Request.Form("TEMPEPQ30407120")
...
<div id="formBlock">
    ...
    <form action="pastmedical9.asp" method="post" id="formQuestion" name="formQuestion">
...
<br>
  <fieldset>
	...
	<% end if %>
		...
		<input type="checkbox" name="TEMPEPQ30407120" value="1" id="TEMPEPQ30407120" class="atLeastOneCheckboxRequired" <%=strTEMPEPQ30407120answer1%>>
		<label for="TEMPEPQ30407120">Pre-diabetes</label><br>

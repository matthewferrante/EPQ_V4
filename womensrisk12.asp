...
Are you currently using non-hormonal birth control methods to prevent pregnancy and/or    sexually transmitted diseases (STDs), such as condoms, a diaphragm, tubal ligation or abstinence?
<br>
	</legend>
	<div class="QuestionAnswersBox">
		...
		<label for="EPQ306170002">No, not currently using a non-hormonal birth control method</label><br>
	</div><!-- [ /#AnswerBox] --> 
  </fieldset>
</div> <!-- [ /#formBlock ] -->

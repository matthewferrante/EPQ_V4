...
<!-- [Question boxes ] -->		
    ...
    <legend class="QuestionBox">
      Have you had any Gyn (gynecological) symptoms in the past 3 months? Check all that apply.<br>
	  </legend>
...
<span class="column1">
		...
		<input type="checkbox" name="TEMPEPQ30530050" value="1" id="TEMPEPQ30530050" <%=strEPQ30530050answer1%>>
		<label for="EPQ30530050">Pelvic pain</label><br>
...
<span class="column2">
		...
		<label for="EPQ30530010">Vaginal bleeding or spotting between periods</label><br>
		...
		<label for="EPQ30530060">Vaginal itching or discomfort</label><br>

...
<!-- [Question boxes ] -->
  <fieldset>
    ...
    <div class="QuestionAnswersBox">
      ...
      <input type="radio" name="EPQ30106000" value="4" id="EPQ301060004" class="qTrigger2 qTriggerOff2" <%=strEPQ30106000student%> >
...
<div class="hiddenQ">
  ...
  <fieldset>
    ...
    <div class="QuestionAnswersBox">
      <input id="EPQ30108000" type="text" size="96" maxlength="96" name="EPQ30108000"  class="requiredIfBranchActive requiredCompleteTextShort2" value='<%=Session("EPQ30108000")%>' ><br>
    </div><!-- [ /#AnswerBox] -->
  </fieldset>
</div>
...
<div class="hiddenQ2">
  <fieldset>
    <legend class="QuestionBox">
      What was your occupation at your former job? (Examples: Secondary school teacher, civil engineer, computer analyst, building supervisor, lathe operator, truck driver, or licensed practical nurse)<br>
    </legend>
    <div class="QuestionAnswersBox">

...
<div id="formBlock">
    ...
    <form action="pastmedical11.asp" method="post" id="formQuestion" name="formQuestion">
...
Which of the following <u>Gyn (gynecological) problems</u> did the doctor say you had? Check all that apply.<br>
	...
	<div class="QuestionAnswersBox">
		...
		<input type="checkbox" name="EPQ30408110" value="1" id="EPQ30408110" class="atLeastOneCheckboxRequired" <%=strEPQ30408110answer1%>>
...
<input type="checkbox" name="EPQ30408070" value="1" id="EPQ30408070" class="atLeastOneCheckboxRequired" <%=strEPQ30408070answer1%>>
		...
		<input type="checkbox" name="TEMP1EPQ30408060" value="1" id="EPQ30408060" class="atLeastOneCheckboxRequired" <%=strTEMP1EPQ30408060answer1%>>
		<label for="EPQ30408060">Sexual dysfunction</label><br>

...
Please check what you are currently taking and/or took in the past: Check all that apply.<br>
	</legend>
	<div class="QuestionAnswersBox">
		<input type="checkbox" name="EPQ30610001" value="1" id="EPQ30610001" <%=strEPQ30610001answer1%>>
		<label for="EPQ30610001">Estrogen patches or gels (Such as Climara, Estrogel, Menostar, Vivelle-Dot)</label><br>
		<input type="checkbox" name="EPQ30610002" value="1" id="EPQ30610002" <%=strEPQ30610002answer1%>>
		<label for="EPQ30610002">Estrogen pills (Such as Estrace, Premarin, Ortho-EST, Estradiol)</label><br>
		<input type="checkbox" name="EPQ30610003" value="1" id="EPQ30610003" <%=strEPQ30610003answer1%>>
		<label for="EPQ30610003">Estrogen vaginal creams and suppositories (Such as Estrace, Estring, Vagifem)</label><br>
		...
		<label for="EPQ30610007">Other, please describe:</label>

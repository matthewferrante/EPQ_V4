...
<div id="formWrapper">
<div id="formBlock">
    <form action="familyhistorycancer6b.asp" method="post" id="formQuestion" name="formQuestion">
...
<%if session("TEMPEPQ30820010Page2")=1 then%>
...
<%if session("EPQ30820010Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Breast cancer</td>
...
<%if session("EPQ30820020Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30820030Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30820040Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Leukemia</td>
...
<%if session("EPQ30820050Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Lung cancer</td>
...
<%if session("EPQ30820060Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Melanoma</td>
...
<% if Session("HM10801000Page2")="1" then  %>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("CUTA10801000Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30820110Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30820070Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30820080Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("TEMP1EPQ30820090Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
				<td>Sarcoma</td>
...
<%if session("TEMP2EPQ30820090Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30820090Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("EPQ30820100Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("TEMP1EPQ30820100Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">
...
<%if session("TEMP2EPQ30820100Page2")=1 then%>
			<tr class="eitherOneOrTwoOrMoreCheckboxes">

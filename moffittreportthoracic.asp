...
strpayload=strpayload&strpayload2&" \par "
		...
		strPayload=strPayload&"____________________________________________________________________________ \par \par"
...
if Session("SurveyVersion")="Cutaneous" then
		...
		strPayload=strPayload&"\ul\b\fs24 Skin Lesion History \ulnone\b0\fs20\ \par "


	if Session("CUTA10501000") = "1" then
		strPayload=strPayload&" \tab Skin Lesion Present: Yes"&" \par "
	end if
	if Session("CUTA10501000") = "2" then
		strPayload=strPayload&" \tab Skin Lesion Present: No"&" \par "
	end if
	if Session("CUTA10502000") = "1" then
		strPayload=strPayload&" \tab Skin Lesion Present for: Less than 6 months"&" \par "
	end if
	if Session("CUTA10502000") = "2" then
		strPayload=strPayload&" \tab Skin Lesion Present for: 6 - 12 months"&" \par "
	end if
	if Session("CUTA10502000") = "3" then
		strPayload=strPayload&" \tab Skin Lesion Present for: 13 months - 2 years"&" \par "
	end if
	if Session("CUTA10502000") = "4" then
		strPayload=strPayload&" \tab Skin Lesion Present for: More than 2 years"&" \par "
	end if

	if Session("CUTA10503000") = "1" then
		strPayload=strPayload&" \tab Skin lesion began as mole: Yes"&" \par "
	end if
	if Session("CUTA10503000") = "2" then
		strPayload=strPayload&" \tab Skin lesion began as mole: No"&" \par "
	end if
	if Session("CUTA10503000") = "3" then
		strPayload=strPayload&" \tab Skin lesion began as mole: Unknown"&" \par "
	end if

	if Session("CUTA10504000") = "1" then
		strPayload=strPayload&" \tab Skin lesion present at birth: Yes"&" \par "
	end if
	if Session("CUTA10504000") = "2" then
		strPayload=strPayload&" \tab Skin lesion present at birth: No"&" \par "
	end if
	if Session("CUTA10504000") = "3" then
		strPayload=strPayload&" \tab Skin lesion present at birth: Unknown"&" \par "
	end if
	if Session("CUTA10505000") = "1" then
		strPayload=strPayload&" \tab Skin lesion changed color: Yes"&" \par "
	end if
	if Session("CUTA10505000") = "2" then
		strPayload=strPayload&" \tab Skin lesion changed color: No"&" \par "
	end if
	if Session("CUTA10505000") = "3" then
		strPayload=strPayload&" \tab Skin lesion changed color: Unknown"&" \par "
	end if
	if Session("CUTA10506000") = "1" then
		strPayload=strPayload&" \tab Skin lesion changed size: Yes"&" \par "
	end if
	if Session("CUTA10506000") = "2" then
		strPayload=strPayload&" \tab Skin lesion changed size: No"&" \par "
	end if
	if Session("CUTA10506000") = "3" then
		strPayload=strPayload&" \tab Skin lesion changed size: Unknown"&" \par "
	end if
	if Session("CUTA10507000") = "1" then
		strPayload=strPayload&" \tab Skin lesion became larger: Yes"&" \par "
	end if
	if Session("CUTA10507000") = "2" then
		strPayload=strPayload&" \tab Skin lesion became larger: No"&" \par "
	end if
	if Session("CUTA10507000") = "3" then
		strPayload=strPayload&" \tab Skin lesion became larger: Unknown"&" \par "
	end if
	if Session("CUTA10508000") = "1" then
		strPayload=strPayload&" \tab Skin lesion changed in shape: Yes"&" \par "
	end if
	if Session("CUTA10508000") = "2" then
		strPayload=strPayload&" \tab Skin lesion changed in shape: No"&" \par "
	end if
	if Session("CUTA10508000") = "3" then
		strPayload=strPayload&" \tab Skin lesion changed in shape: Unknown"&" \par "
	end if
	if Session("CUTA10509000") = "1" then
		strPayload=strPayload&" \tab Skin lesion changed in elevation: Yes"&" \par "
	end if
	if Session("CUTA10509000") = "2" then
		strPayload=strPayload&" \tab Skin lesion changed in elevation: No"&" \par "
	end if
	if Session("CUTA10509000") = "3" then
		strPayload=strPayload&" \tab Skin lesion changed in elevation: Unknown"&" \par "
	end if
	if Session("CUTA10510000") = "1" then
		strPayload=strPayload&" \tab Skin lesion became scaly/crusty: Yes"&" \par "
	end if
	if Session("CUTA10510000") = "2" then
		strPayload=strPayload&" \tab Skin lesion became scaly/crusty: No"&" \par "
	end if
	if Session("CUTA10510000") = "3" then
		strPayload=strPayload&" \tab Skin lesion became scaly/crusty: Unknown"&" \par "
	end if

if Session("CUTA10511000") = "1" then
		strPayload=strPayload&" \tab Skin lesion opened or bled: Yes"&" \par "
	end if
	if Session("CUTA10511000") = "2" then
		strPayload=strPayload&" \tab Skin lesion opened or bled: No"&" \par "
	end if
	if Session("CUTA10511000") = "3" then
		strPayload=strPayload&" \tab Skin lesion opened or bled: Unknown"&" \par "
	end if

	if Session("CUTA10512000") = "1" then
		strPayload=strPayload&" \tab Skin lesion pain: Yes"&" \par "
	end if
	if Session("CUTA10512000") = "2" then
		strPayload=strPayload&" \tab Skin lesion pain: No"&" \par "
	end if
	if Session("CUTA10512000") = "3" then
		strPayload=strPayload&" \tab Skin lesion pain: Unknown"&" \par "
	end if
	if Session("CUTA105113000") = "1" then
		strPayload=strPayload&" \tab Skin lesion trauma: Yes"&" \par "
	end if
	if Session("CUTA10513000") = "2" then
		strPayload=strPayload&" \tab Skin lesion trauma: No"&" \par "
	end if
	if Session("CUTA10513000") = "3" then
		strPayload=strPayload&" \tab Skin lesion trauma: Unknown"&" \par "
	end if
...
strpayload=strpayload & strPHCGroup & " \tab Melanoma, Age at first diagnosis: "&Session("CUTA10302000string")&""& "  \par "
end if
...
if len(Session("CUTA10304000")) > 0 then
strpayload=strpayload & strPHCGroup & " \tab Non-melanoma, Age at first diagnosis: "&Session("CUTA10304000string")&""& "  \par "
end if
...
strpayload=strpayload & " \par "
	...
	if Session("CUTA10401000") = "1" then
		strPayload=strPayload&" \tab Diagnosed with Xeroderma Pigmentosa: Yes"&" \par "
	end if
	if Session("CUTA10401000") = "2" then
		strPayload=strPayload&" \tab Diagnosed with Xeroderma Pigmentosa: No"&" \par "
	end if
	if Session("CUTA10401000") = "3" then
		strPayload=strPayload&" \tab Diagnosed with Xeroderma Pigmentosa: Unknown"&" \par "
	end if
	if Session("CUTA10402000") = "1" then
		strPayload=strPayload&" \tab Photosensitivity: Yes"&" \par "
	end if
	if Session("CUTA10402000") = "2" then
		strPayload=strPayload&" \tab Photosensitivity: No"&" \par "
	end if
	if Session("CUTA10402000") = "3" then
		strPayload=strPayload&" \tab Photosensitivity: Unknown"&" \par "
	end if
	if Session("CUTA10403000") = "1" then
		strPayload=strPayload&" \tab Had an organ transplant: Yes"&" \par "
	end if
	if Session("CUTA10403000") = "2" then
		strPayload=strPayload&" \tab Had an organ transplant: No"&" \par "
	end if
	if Session("CUTA10403000") = "3" then
		strPayload=strPayload&" \tab Had an organ transplant: Unknown"&" \par "
	end if
...
strPayload=strPayload&"  \tab Diabetes  \par "
end if
...
strPayload=strPayload&"  \tab Dementia including Alzheimer's   \par "
end if
...
strPayload=strPayload&"  \tab Abormal PSA \par "
end if
...
strPayload=strPayload&"  \tab Dementia   \par "
end if
...
strPayload=strPayload&"  \tab COPD   \par "
end if
...
strPayload=strPayload&"  \tab Asthma   \par "
end if
if Session("EPQ30415070")="1" then
strPayload=strPayload&"  \tab Emphysema   \par "
end if
if Session("EPQ30415100")="1" then
strPayload=strPayload&"  \tab Chronic bronchitis   \par "
end if
if Session("EPQ30415030")="1" then
strPayload=strPayload&"  \tab Pleurisy   \par "
end if
if Session("EPQ30415040")="1" then
strPayload=strPayload&"  \tab Pneumonia   \par "
end if
...
strPayload=strPayload&"  \tab Eczema   \par "
end if
...
strPayload=strPayload&"  \tab Hay fever or allergic rhinitis  \par "
end if
...
strPayload2=strPayload2&" \tab Collectomy (removal of all or part of the colon) \tab\tab "&Session("EPQ30754490") & " time(s) "
...
if Session("SurveyVersion")="Cutaneous" then
	...
	strPayload=strPayload&"\ulnone\b0\fs20\tab Pregnant when diagnosed \par "
	strPayload=strPayload&"\tab with skin cancer \tab\tab "

	if Session("CUTA10601000")="1" then
	strPayload=strPayload&"Yes"
	end if
	if Session("CUTA10601000")="2" then
	strPayload=strPayload&"No"
	end if
	if Session("CUTA10601000")="88" then
	strPayload=strPayload&"Unknown"
	end if
	strPayload=strPayload&" \par "
...
if Session("EPQ30602003")="1" then
strPayload2=strPayload2&", Pregnant or nursing"
end if
if Session("EPQ30602003")="2" then
strPayload2=strPayload2&", Hormonally induced menstrual cessation"
end if
...
strPayload2=strPayload2&", PT needs help with OC hx"
	...
	if Session("EPQ30614007") = "1" then
		strpayload2=strpayload2& ", "&Session("EPQ30614009")
	end if
...
if Session("EPQ30803000c") <> "1" then
	...
	strpayload2=""
	if Session("EPQ30803000a") ="1" then
	strPayload2=strPayload2&", Maternal Japanese ancestry \par"
	end if
	if Session("EPQ30803000b") ="1" then
	strPayload2=strPayload2&", Paternal Japanese ancestry \par"
	end if
	if Session("EPQ30803000c") ="1" then
	strPayload2=strPayload2&", \par"
	end if
...
if Session("CUTA10801000")="1"  or Session("CUTA10803000")="1" then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab Skin Cancer (includes\par \tab basal, squamous, etc.\par \tab but not melanoma) "
end if
strPayload3=" \tab\tab\tab "
...
if Session("THRC30200000")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Female Breast Cancer "&"  \par "
end if
if Session("THRC30200010")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Male Breast Cancer "&"  \par "
end if
if Session("THRC30200020")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Colon/Rectal Cancer "&"  \par "
end if
if Session("THRC30200030")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Endometrial or Uterine Breast Cancer "&"  \par "
end if
if Session("THRC30200040")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Kidney Cancer "&"  \par "
end if
if Session("THRC30200050")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Leukemia "&"  \par "
end if
if Session("THRC30200060")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Lung Cancer "&"  \par "
end if
if Session("THRC30200070")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Melanoma Cancer "&"  \par "
end if
if Session("THRC30200080")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Ovarian Cancer "&"  \par "
end if
if Session("THRC30200090")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Pancreatic Cancer "&"  \par "
end if
if Session("THRC30200100")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Prostate Cancer "&"  \par "
end if
if Session("THRC30200110")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Thyroid Cancer "&"  \par "
end if
if Session("THRC30200120")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab 2nd Degree Other Cancer "&"  \par "
end if

if Session("THRC308200130")="1"  then
	strPayload2=strPayload2&" \ulnone\b0\fs20\tab No 2nd Degree Cancer "&"  \par "
end if
...
strpayload=strpayload&strpayload2
	...
	strPayload=strPayload&" \ul\b\fs24\par Medication History \par"
		strPayload=strPayload&" \ulnone\b0\fs20\tab High blood pressure medication: \tab\tab\tab " &Session("CUTA11122000string")&" \par"
		strPayload=strPayload&" \tab Cholesterol-lowering medication:  \tab\tab\tab " &Session("CUTA11123000string")&" \par"
		strPayload=strPayload&" \tab Asthma medication:  \tab\tab\tab\tab\tab " &Session("CUTA11124000string")&" \par"
		strPayload=strPayload&" \tab Thyroid medication:  \tab\tab\tab\tab\tab " &Session("CUTA11125000string")&" \par"
		strPayload=strPayload&" \tab Steroids or other immune suppressant medication:   \tab " &Session("CUTA11126000string")&" \par"
		strPayload=strPayload&" \tab Antidepressant medication usage history:  \tab\tab " &Session("CUTA11127000string")&" \par"
...
strPayload2=strPayload2&", Every day"
end if
if Session("EPQ31148000")="2" then
strPayload2=strPayload2&", Some days"
end if
...
strPayload=strPayload&"\tab\tab\tab\tab Pack Year:"&Session("PackYears")&" \par "
end if
...
if Session("EPQ31158000")="1" OR Session("EPQ31158000")="2" OR Session("EPQ31159000")="1" OR Session("EPQ31159000")="2" then
...
strPayload=strPayload&""&Session("EPQ31101000")&" ' "&Session("EPQ31101000b")&" "" "&" "
end if
strPayload=strPayload&Session("EPQ31102000")&" lbs; "&" "
...
strPayload=strPayload&" (BMI="&Session("BMI")&");"&"Weight 1 yr ago: "&Session("EPQ31103000")&" lbs; "&" \par "


Session("VegScore")=0

if Session("EPQ31111000")="0" then
Session("VegScore")=Session("VegScore")+0
end if
...
Session("VegScore")=Session("VegScore")+1
end if
if Session("EPQ31111000")="3" then
Session("VegScore")=Session("VegScore")+2
end if
if Session("EPQ31111000")="4" then
Session("VegScore")=Session("VegScore")+5
end if
if Session("EPQ31111000")="5" then
Session("VegScore")=Session("VegScore")+10
end if
...
Session("VegTotal")
If Session("VegScore") <= 19 then
Session("VegTotal")="Insufficient intake"
else
Session("VegTotal")="Sufficient intake"
end if
strPayload=strPayload&" \ulnone\b0\fs20\tab Vegetables \tab\tab "&Session("VegTotal")

dim FruitScore
Session("FruitScore")=CInt(0)

if Session("EPQ31116000")="0" then
FruitScore=FruitScore+0
end if
...
Session("FruitScore")=FruitScore
Session("FruitTotal")
If FruitScore <= 9 then
Session("FruitTotal")="Insufficient intake"
else
Session("FruitTotal")="Sufficient intake"
end if

strpayload=strpayload&" \par"
strPayload=strPayload&" \ulnone\b0\fs20\tab Fruits \tab\tab\tab "&Session("FruitTotal")
...
strPayload2=strPayload2&"Number of moles larger than one quarter:  "&Session("CUTA11101000string")&" "&" \par "
end if

if len(Session("CUTA11102000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Presence of atypical moles: "&Session("CUTA11102000string")&" "&" \par "

end if

if len(Session("CUTA11103000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Natural eye color: "&Session("CUTA11103000string")&" "&" \par "
end if

if len(Session("CUTA11104000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Natural hair color: "&Session("CUTA11104000string")&" "&" \par "
end if

if len(Session("CUTA11105000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Color of untanned skin: "&Session("CUTA11105000Ostring")&" "&" \par "
end if
if len(Session("CUTA11106000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Skin tanning: "&Session("CUTA11106000string")&" "&" \par "
end if


if len(Session("CUTA11107000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Work outdoors: "&Session("CUTA11107000string")&" "&" \par "
end if
if len(Session("CUTA11108000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Percentage spent outdoors: "&Session("CUTA11108000string")&" "&" \par "
end if
if len(Session("CUTA11109000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Face Sunscreen: "&Session("CUTA11109000string")&" \par "
end if
if len(Session("CUTA11110000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Face Sunscreen usage: "&Session("CUTA11110000string")&" "&" \par"
end if
if len(Session("CUTA11111000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Face Sunscreen SPF: "&Session("CUTA11111000string")&" \par "
end if
if len(Session("CUTA11112000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Body Sunscreen: "&Session("CUTA11112000string")&" "&" \par "
end if
if len(Session("CUTA11113000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Body Sunscreen usage: "&Session("CUTA11113000string")&" "&" \par "
end if
if len(Session("CUTA11114000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Body Sunscreen SPF: "&Session("CUTA11114000string")&" "&" \par "
end if
if len(Session("CUTA11115000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Treated for psoriasis: "&Session("CUTA11115000string")&" "&" \par "
end if
if len(Session("CUTA11116000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Phototherapy for psoriasis: "&Session("CUTA11116000string")&" "&" \par "
end if
if len(Session("CUTA11117000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Performs skin self-exams: "&Session("CUTA11117000string")&" "&" \par "
end if
if len(Session("CUTA11118000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Skin self-exam frequency: "&Session("CUTA11118000string")&" "&" \par "
end if
if len(Session("CUTA11119000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Skin screenings by a health professional: "&Session("CUTA11119000string")&" "&" \par "
end if
if len(Session("CUTA11120000")) > 0 then
strPayload2=strPayload2&"\tab\tab\tab\tab Last skin screening: "&Session("CUTA11120000string")&" "&" \par "
end if
...
Session("TXN")="TN^Thoracic Questionnaire"
else
...
if Session("ProductionModeSpoke")="C" then
if Session("SurveyVersion")="Cutaneous" then
Session("TXN")="TN^Cutaneous Questionnaire"
end if
end if
...
'RETIRED UNLESS BROUGHT BACK
	...
	strXMLContent=strXMLContent&"Self Reported Gender"
	strXMLContent=strXMLContent&"</ID>"&"<Narrative>"
	strXMLContent=strXMLContent&"Patient Reports Gender Differently than Scheduling"
	strXMLContent=strXMLContent&"</Narrative>"& chr(&H0d)&"<Doctor_Narrative>"
	strXMLContent=strXMLContent&Session("epq30100100string")
	...
	strXMLContent=strXMLContent&"Patient Self Reports "&Session("Gender")
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"GenderChangeSelfReported"
...
'	strXMLContent=strXMLContent&"<Survey_Version>"&SurveyVersionNumber&"</Survey_Version>"& chr(&H0d)
'	strXMLContent=strXMLContent&"<Question_No><ID>"
'	strXMLContent=strXMLContent&"EPQ30100100"
'	strXMLContent=strXMLContent&"</ID>"&"<Narrative>"
'	strXMLContent=strXMLContent&Session("epq30100100string")
'	strXMLContent=strXMLContent&"</Narrative>"& chr(&H0d)&"<Doctor_Narrative>"
'	strXMLContent=strXMLContent&Session("epq30100100string")
...
'	strXMLContent=strXMLContent&"</SNOMEDCT_Code>"& chr(&H0d)
'	strXMLContent=strXMLContent&"<Response>"
'	strXMLContent=strXMLContent&"0"
'	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
'	strXMLContent=strXMLContent&"<Control_ID>"
'	strXMLContent=strXMLContent&"EPQ_GenderChangeNo"
'	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
'	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
'	end if
...
'	strXMLContent=strXMLContent&"<Survey_Version>"&SurveyVersionNumber&"</Survey_Version>"& chr(&H0d)
	...
	strXMLContent=strXMLContent&"<Survey_Version>"&SurveyVersionNumber&"</Survey_Version>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Question_No><ID>"
	strXMLContent=strXMLContent&"EPQ30101000"
	strXMLContent=strXMLContent&"</ID>"&"<Narrative>"
	strXMLContent=strXMLContent&Session("epq30101000string")
	strXMLContent=strXMLContent&"</Narrative>"& chr(&H0d)&"<Doctor_Narrative>"
	strXMLContent=strXMLContent&Session("epq30101000string")
	strXMLContent=strXMLContent&"</Doctor_Narrative>"& chr(&H0d)&"</Question_No>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Medcin_Code><ID>"
	...
	strXMLContent=strXMLContent&"</SNOMEDCT_Code>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Response>"
	strXMLContent=strXMLContent&Session("epq30101000")
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbSexMale"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbSexFemale"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"<Survey_Version>"&SurveyVersionNumber&"</Survey_Version>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Question_No><ID>"
	strXMLContent=strXMLContent&"EPQ30102000"
	strXMLContent=strXMLContent&"</ID>"&"<Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30102000string")
	strXMLContent=strXMLContent&"</Narrative>"& chr(&H0d)&"<Doctor_Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30102000string")
	strXMLContent=strXMLContent&"</Doctor_Narrative>"& chr(&H0d)&"</Question_No>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Medcin_Code><ID>"
	...
	strXMLContent=strXMLContent&"</SNOMEDCT_Code>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Response>"
	strXMLContent=strXMLContent&Session("EPQ30102000")
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbHispanicYes"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbHispanicNo"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"<Survey_Version>"&SurveyVersionNumber&"</Survey_Version>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Question_No><ID>"
	strXMLContent=strXMLContent&"EPQ30103000"
	strXMLContent=strXMLContent&"</ID>"&"<Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30103000string")
	strXMLContent=strXMLContent&"</Narrative>"& chr(&H0d)&"<Doctor_Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30103000string")
	strXMLContent=strXMLContent&"</Doctor_Narrative>"& chr(&H0d)&"</Question_No>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Medcin_Code><ID>"
	...
	strXMLContent=strXMLContent&"</SNOMEDCT_Code>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Response>"
	strXMLContent=strXMLContent&Session("EPQ30103000")
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbRaceWhite"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbRaceBlack"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbRaceAsian"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbRaceHawaiian"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbRaceNativeAmerican"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbNotSure"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbRaceOther"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</SNOMEDCT_Code>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Response>"
	strXMLContent=strXMLContent&"NULL"
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_rdbRaceAnswer"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	if len (Session("EPQ30103001")) >0 then
	strXMLContent=strXMLContent&"<Finding>"& chr(&H0d)
	strXMLContent=strXMLContent&"<ETLTrackingID>"&Session("ETLTrackingID")&"</ETLTrackingID>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Code_State>Positive"
	strXMLContent=strXMLContent&"</Code_State>"& chr(&H0d)
	...
	strXMLContent=strXMLContent&"<Survey_Version>"&SurveyVersionNumber&"</Survey_Version>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Question_No><ID>"
	strXMLContent=strXMLContent&"EPQ30103001"
	strXMLContent=strXMLContent&"</ID>"&"<Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30103001string")
	strXMLContent=strXMLContent&"</Narrative>"& chr(&H0d)&"<Doctor_Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30103001string")
	strXMLContent=strXMLContent&"</Doctor_Narrative>"& chr(&H0d)&"</Question_No>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Medcin_Code><ID>"
	...
	strXMLContent=strXMLContent&"</SNOMEDCT_Code>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Response>"
	strXMLContent=strXMLContent&Session("EPQ30103001")
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M11_txtOtherRace"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"<Survey_Version>"&SurveyVersionNumber&"</Survey_Version>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Question_No><ID>"
	strXMLContent=strXMLContent&"EPQ30104000"
	strXMLContent=strXMLContent&"</ID>"&"<Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30104000string")
	strXMLContent=strXMLContent&"</Narrative>"& chr(&H0d)&"<Doctor_Narrative>"
	strXMLContent=strXMLContent&Session("EPQ30104000string")
	strXMLContent=strXMLContent&"</Doctor_Narrative>"& chr(&H0d)&"</Question_No>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Medcin_Code><ID>"
	...
	strXMLContent=strXMLContent&"</SNOMEDCT_Code>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Response>"
	strXMLContent=strXMLContent&Session("EPQ30104000")
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M12_rdbMaritalSingle"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M12_rdbMaritalMarried"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M12_rdbMaritalWidowed"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if
	...
	strXMLContent=strXMLContent&"</Response>"& chr(&H0d)
	strXMLContent=strXMLContent&"<Control_ID>"
	strXMLContent=strXMLContent&"M12_rdbMaritalLiving"
	strXMLContent=strXMLContent&"</Control_ID>"& chr(&H0d)
	strXMLContent=strXMLContent&"</Finding>"& chr(&H0d)
	end if

...
Please list medical problems, diseases, or conditions that you may have been diagnosed with other than cancer.
  ...
  <fieldset>
    <legend class="QuestionBox">
      Which of the following <u>gynecological disorders</u> did the doctor say you had? Check all that apply.<br>
	  </legend>
	<div class="QuestionAnswersBox">
		...
		<label for="EPQ304081100">Human Papillomavirus (HPV) infection</label><br>
		...
		<label for="EPQ30408070">Pelvic inflammatory disease</label><br>
		...
		<label for="EPQ30408020">Ovarian cysts</label><br>
		<input type="checkbox" name="EPQ30408060" value="1" id="EPQ30408060" class="atLeastOneCheckboxRequired" <%=strEPQ30408060answer1%>>
		<label for="EPQ30408060">Tumor of the uterus or womb that was not cancer</label><br>
		<input type="checkbox" name="EPQ30408080" value="1" id="EPQ30408080" class="atLeastOneCheckboxRequired" <%=strEPQ30408080answer1%>>
		<label for="EPQ30408080">Uterine fibroids or fibroid tumors</label><br>
